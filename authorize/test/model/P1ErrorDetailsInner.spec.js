...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiAuthorize.P1ErrorDetailsInner();
  });
  ...
  describe('P1ErrorDetailsInner', function() {
    it('should create an instance of P1ErrorDetailsInner', function() {
      ...
      //var instance = new PingOnePlatformApiAuthorize.P1ErrorDetailsInner();
      //expect(instance).to.be.a(PingOnePlatformApiAuthorize.P1ErrorDetailsInner);
    });
