...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiAuthorize.ObjectEnvironment();
  });
  ...
  describe('ObjectEnvironment', function() {
    it('should create an instance of ObjectEnvironment', function() {
      ...
      //var instance = new PingOnePlatformApiAuthorize.ObjectEnvironment();
      //expect(instance).to.be.a(PingOnePlatformApiAuthorize.ObjectEnvironment);
    });
