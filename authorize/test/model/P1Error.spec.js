...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiAuthorize.P1Error();
  });
  ...
  describe('P1Error', function() {
    it('should create an instance of P1Error', function() {
      ...
      //var instance = new PingOnePlatformApiAuthorize.P1Error();
      //expect(instance).to.be.a(PingOnePlatformApiAuthorize.P1Error);
    });
