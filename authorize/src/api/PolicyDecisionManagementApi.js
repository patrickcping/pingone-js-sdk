    ...
    */
    ...
    createDecisionEndpointWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/decisionEndpoints', 'POST',
    ...
    createDecisionEndpoint(environmentID, opts) {
      return this.createDecisionEndpointWithHttpInfo(environmentID, opts)
    ...
    deleteDecisionEndpointWithHttpInfo(environmentID, decisionEndpointID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/decisionEndpoints/{decisionEndpointID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteDecisionEndpoint(environmentID, decisionEndpointID) {
      return this.deleteDecisionEndpointWithHttpInfo(environmentID, decisionEndpointID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllDecisionEndpointsWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/decisionEndpoints', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllDecisionEndpoints(environmentID) {
      return this.readAllDecisionEndpointsWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneDecisionEndpointWithHttpInfo(environmentID, decisionEndpointID) {
      ...
      let returnType = DecisionEndpoint;
      return this.apiClient.callApi(
        '/environments/{environmentID}/decisionEndpoints/{decisionEndpointID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneDecisionEndpoint(environmentID, decisionEndpointID) {
      return this.readOneDecisionEndpointWithHttpInfo(environmentID, decisionEndpointID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateDecisionEndpointWithHttpInfo(environmentID, decisionEndpointID, opts) {
      ...
      let returnType = DecisionEndpoint;
      return this.apiClient.callApi(
        '/environments/{environmentID}/decisionEndpoints/{decisionEndpointID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateDecisionEndpoint(environmentID, decisionEndpointID, opts) {
      return this.updateDecisionEndpointWithHttpInfo(environmentID, decisionEndpointID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
