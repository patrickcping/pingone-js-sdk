...
export default class APIServersApi {
  ...
  */
  ...
  createAPIServerWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/apiServers', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createAPIServer(environmentID, opts) {
    return this.createAPIServerWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteAPIServerWithHttpInfo(environmentID, apiServerID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/apiServers/{apiServerID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteAPIServer(environmentID, apiServerID) {
    return this.deleteAPIServerWithHttpInfo(environmentID, apiServerID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllAPIServersWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/apiServers', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllAPIServers(environmentID) {
    return this.readAllAPIServersWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneAPIServerWithHttpInfo(environmentID, apiServerID) {
    ...
    let accepts = ['application/json'];
    let returnType = APIServer;
    return this.apiClient.callApi('/environments/{environmentID}/apiServers/{apiServerID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneAPIServer(environmentID, apiServerID) {
    return this.readOneAPIServerWithHttpInfo(environmentID, apiServerID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateAPIServerWithHttpInfo(environmentID, apiServerID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = APIServer;
    return this.apiClient.callApi('/environments/{environmentID}/apiServers/{apiServerID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateAPIServer(environmentID, apiServerID, opts) {
    return this.updateAPIServerWithHttpInfo(environmentID, apiServerID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}