...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiAgreementManagement.P1ErrorDetailsInner();
  });
  ...
  describe('P1ErrorDetailsInner', function() {
    it('should create an instance of P1ErrorDetailsInner', function() {
      ...
      //var instance = new PingOnePlatformApiAgreementManagement.P1ErrorDetailsInner();
      //expect(instance).to.be.a(PingOnePlatformApiAgreementManagement.P1ErrorDetailsInner);
    });
