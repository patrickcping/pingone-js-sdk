...
class ApiClient {
   ...
   */
  constructor(basePath = 'https://agreement-mgmt.pingone.com') {
    /**
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
     * @default https://agreement-mgmt.pingone.com
     */
     ...
     */
    this.defaultHeaders = {
      'User-Agent': 'pingtools PingOne-JS-SDK-agreementmanagement/0.0.1'
    };
    ...
    return [{
      ...
      'variables': {
        suffix: {
          ...
          'default_value': "com",
          'enum_values': ["eu", "com", "asia", "ca"]
        },
        baseDomain: {
          'description': "No description provided",
          'default_value': "agreement-mgmt.pingone"
        },
        protocol: {
          'description': "No description provided",
          'default_value': "https"
      ...
      'variables': {
        baseHostname: {
          'description': "No description provided",
          'default_value': "agreement-mgmt.pingone.com"
        },
        protocol: {
          'description': "No description provided",
          'default_value': "https"
