...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorIPReputation();
  });
  ...
  describe('RiskPredictorIPReputation', function() {
    it('should create an instance of RiskPredictorIPReputation', function() {
      // uncomment below and update the code to test RiskPredictorIPReputation
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorIPReputation();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorIPReputation);
    });
