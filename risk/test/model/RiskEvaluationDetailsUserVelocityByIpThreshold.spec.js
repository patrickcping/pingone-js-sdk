...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskEvaluationDetailsUserVelocityByIpThreshold();
  });
  ...
  describe('RiskEvaluationDetailsUserVelocityByIpThreshold', function() {
    it('should create an instance of RiskEvaluationDetailsUserVelocityByIpThreshold', function() {
      // uncomment below and update the code to test RiskEvaluationDetailsUserVelocityByIpThreshold
      //var instance = new PingOnePlatformApiPingOneRisk.RiskEvaluationDetailsUserVelocityByIpThreshold();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskEvaluationDetailsUserVelocityByIpThreshold);
    });
