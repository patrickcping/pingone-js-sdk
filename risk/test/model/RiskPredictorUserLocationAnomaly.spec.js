...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorUserLocationAnomaly();
  });
  ...
  describe('RiskPredictorUserLocationAnomaly', function() {
    it('should create an instance of RiskPredictorUserLocationAnomaly', function() {
      // uncomment below and update the code to test RiskPredictorUserLocationAnomaly
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorUserLocationAnomaly();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorUserLocationAnomaly);
    });
