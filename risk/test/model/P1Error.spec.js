...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.P1Error();
  });
  ...
  describe('P1Error', function() {
    it('should create an instance of P1Error', function() {
      ...
      //var instance = new PingOnePlatformApiPingOneRisk.P1Error();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.P1Error);
    });
