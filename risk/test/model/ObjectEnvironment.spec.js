...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.ObjectEnvironment();
  });
  ...
  describe('ObjectEnvironment', function() {
    it('should create an instance of ObjectEnvironment', function() {
      ...
      //var instance = new PingOnePlatformApiPingOneRisk.ObjectEnvironment();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.ObjectEnvironment);
    });
