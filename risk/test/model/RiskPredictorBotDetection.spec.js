...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorBotDetection();
  });
  ...
  describe('RiskPredictorBotDetection', function() {
    it('should create an instance of RiskPredictorBotDetection', function() {
      // uncomment below and update the code to test RiskPredictorBotDetection
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorBotDetection();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorBotDetection);
    });
