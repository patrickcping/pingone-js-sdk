...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorAnonymousNetwork();
  });
  ...
  describe('RiskPredictorAnonymousNetwork', function() {
    it('should create an instance of RiskPredictorAnonymousNetwork', function() {
      // uncomment below and update the code to test RiskPredictorAnonymousNetwork
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorAnonymousNetwork();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorAnonymousNetwork);
    });
