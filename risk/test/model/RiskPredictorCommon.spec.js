...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorCommon();
  });
  ...
  describe('RiskPredictorCommon', function() {
    it('should create an instance of RiskPredictorCommon', function() {
      // uncomment below and update the code to test RiskPredictorCommon
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorCommon();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorCommon);
    });
