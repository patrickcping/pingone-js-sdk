...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorComposite();
  });
  ...
  describe('RiskPredictorComposite', function() {
    it('should create an instance of RiskPredictorComposite', function() {
      // uncomment below and update the code to test RiskPredictorComposite
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorComposite();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorComposite);
    });
