...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictor();
  });
  ...
  describe('RiskPredictor', function() {
    it('should create an instance of RiskPredictor', function() {
      // uncomment below and update the code to test RiskPredictor
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictor();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictor);
    });
    ...
    it('should have the property detect (base name: "detect")', function() {
      // uncomment below and update the code to test the property detect
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictor();
      //expect(instance).to.be();
    });

    it('should have the property activationAt (base name: "activationAt")', function() {
      // uncomment below and update the code to test the property activationAt
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictor();
      //expect(instance).to.be();
    });
    ...
    it('should have the property slidingWindow (base name: "slidingWindow")', function() {
      // uncomment below and update the code to test the property slidingWindow
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictor();
      //expect(instance).to.be();
    });
