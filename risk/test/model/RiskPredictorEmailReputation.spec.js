...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorEmailReputation();
  });
  ...
  describe('RiskPredictorEmailReputation', function() {
    it('should create an instance of RiskPredictorEmailReputation', function() {
      // uncomment below and update the code to test RiskPredictorEmailReputation
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorEmailReputation();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorEmailReputation);
    });
