...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorGeovelocity();
  });
  ...
  describe('RiskPredictorGeovelocity', function() {
    it('should create an instance of RiskPredictorGeovelocity', function() {
      // uncomment below and update the code to test RiskPredictorGeovelocity
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorGeovelocity();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorGeovelocity);
    });
