...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorVelocity();
  });
  ...
  describe('RiskPredictorVelocity', function() {
    it('should create an instance of RiskPredictorVelocity', function() {
      // uncomment below and update the code to test RiskPredictorVelocity
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorVelocity();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorVelocity);
    });
