...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorAdversaryInTheMiddle();
  });
  ...
  describe('RiskPredictorAdversaryInTheMiddle', function() {
    it('should create an instance of RiskPredictorAdversaryInTheMiddle', function() {
      // uncomment below and update the code to test RiskPredictorAdversaryInTheMiddle
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorAdversaryInTheMiddle();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorAdversaryInTheMiddle);
    });
