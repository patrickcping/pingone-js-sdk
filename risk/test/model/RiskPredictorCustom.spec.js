...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorCustom();
  });
  ...
  describe('RiskPredictorCustom', function() {
    it('should create an instance of RiskPredictorCustom', function() {
      // uncomment below and update the code to test RiskPredictorCustom
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorCustom();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorCustom);
    });
