...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorCustomAllOfMap();
  });
  ...
  describe('RiskPredictorCustomAllOfMap', function() {
    it('should create an instance of RiskPredictorCustomAllOfMap', function() {
      // uncomment below and update the code to test RiskPredictorCustomAllOfMap
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorCustomAllOfMap();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorCustomAllOfMap);
    });
