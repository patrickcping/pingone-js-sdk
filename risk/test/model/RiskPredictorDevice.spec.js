...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorDevice();
  });
  ...
  describe('RiskPredictorDevice', function() {
    it('should create an instance of RiskPredictorDevice', function() {
      // uncomment below and update the code to test RiskPredictorDevice
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorDevice();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorDevice);
    });
