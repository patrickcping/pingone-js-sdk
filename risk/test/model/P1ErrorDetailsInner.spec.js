...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.P1ErrorDetailsInner();
  });
  ...
  describe('P1ErrorDetailsInner', function() {
    it('should create an instance of P1ErrorDetailsInner', function() {
      ...
      //var instance = new PingOnePlatformApiPingOneRisk.P1ErrorDetailsInner();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.P1ErrorDetailsInner);
    });
