...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneRisk.RiskPredictorVelocityAllOfFallback();
  });
  ...
  describe('RiskPredictorVelocityAllOfFallback', function() {
    it('should create an instance of RiskPredictorVelocityAllOfFallback', function() {
      // uncomment below and update the code to test RiskPredictorVelocityAllOfFallback
      //var instance = new PingOnePlatformApiPingOneRisk.RiskPredictorVelocityAllOfFallback();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneRisk.RiskPredictorVelocityAllOfFallback);
    });
