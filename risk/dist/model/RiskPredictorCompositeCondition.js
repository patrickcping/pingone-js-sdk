...
class RiskPredictorCompositeCondition {
  ...
  constructor(instance = null) {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `RiskPredictorCompositeCondition` with oneOf schemas RiskPredictorCompositeAnd, RiskPredictorCompositeConditionOneOf, RiskPredictorCompositeConditionOneOf1, RiskPredictorCompositeNot, RiskPredictorCompositeOr. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
