...
/**
 * The RiskPredictorAdversaryInTheMiddle model module.
 * @module model/RiskPredictorAdversaryInTheMiddle
 * @version 2023-06-29
 */
class RiskPredictorAdversaryInTheMiddle {
  /**
   * Constructs a new <code>RiskPredictorAdversaryInTheMiddle</code>.
   * @alias module:model/RiskPredictorAdversaryInTheMiddle
  ...
  constructor(name, compactName, type) {
    ...
    RiskPredictorAdversaryInTheMiddle.initialize(this, name, compactName, type);
  }
  ...
  /**
   * Constructs a <code>RiskPredictorAdversaryInTheMiddle</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskPredictorAdversaryInTheMiddle} obj Optional instance to populate.
   * @return {module:model/RiskPredictorAdversaryInTheMiddle} The populated <code>RiskPredictorAdversaryInTheMiddle</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RiskPredictorAdversaryInTheMiddle();
  ...
  /**
   * Validates the JSON data with respect to <code>RiskPredictorAdversaryInTheMiddle</code>.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskPredictorAdversaryInTheMiddle</code>.
   */
  static validateJSON(data) {
    // check to make sure all required properties are present in the JSON string
    for (const property of RiskPredictorAdversaryInTheMiddle.RequiredProperties) {
...
RiskPredictorAdversaryInTheMiddle.RequiredProperties = ["name", "compactName", "type"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
RiskPredictorAdversaryInTheMiddle.prototype['_links'] = undefined;

/**
 * A string that specifies the resource’s unique identifier.
 * @member {String} id
 */
RiskPredictorAdversaryInTheMiddle.prototype['id'] = undefined;
 ...
 * @member {String} name
 */
RiskPredictorAdversaryInTheMiddle.prototype['name'] = undefined;
 ...
 */
RiskPredictorAdversaryInTheMiddle.prototype['compactName'] = undefined;

/**
 * @member {module:model/EnumPredictorType} type
 */
RiskPredictorAdversaryInTheMiddle.prototype['type'] = undefined;

/**
 * A string type. This specifies the description of the risk predictor. Maximum length is 1024 characters.
 * @member {String} description
 */
RiskPredictorAdversaryInTheMiddle.prototype['description'] = undefined;

/**
 * The time the resource was created.
 * @member {Date} createdAt
 */
RiskPredictorAdversaryInTheMiddle.prototype['createdAt'] = undefined;

/**
 * The time the resource was updated.
 * @member {Date} updatedAt
 */
RiskPredictorAdversaryInTheMiddle.prototype['updatedAt'] = undefined;

/**
 * Indicates whether PingOne Risk is licensed for the environment.
 * @member {Boolean} licensed
 */
RiskPredictorAdversaryInTheMiddle.prototype['licensed'] = undefined;

/**
 * A boolean to indicate whether the predictor is deletable in the environment.
 * @member {Boolean} deletable
 */
RiskPredictorAdversaryInTheMiddle.prototype['deletable'] = undefined;

/**
 * @member {module:model/RiskPredictorCommonDefault} default
 */
RiskPredictorAdversaryInTheMiddle.prototype['default'] = undefined;

/**
 * @member {module:model/RiskPredictorCommonCondition} condition
 */
RiskPredictorAdversaryInTheMiddle.prototype['condition'] = undefined;
 ...
 */
RiskPredictorAdversaryInTheMiddle.prototype['whiteList'] = undefined;
...
export default RiskPredictorAdversaryInTheMiddle;