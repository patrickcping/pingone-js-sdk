...
/**
 * The RiskPredictorCustom model module.
 * @module model/RiskPredictorCustom
 * @version 2023-06-29
 */
class RiskPredictorCustom {
  /**
   * Constructs a new <code>RiskPredictorCustom</code>.
   * @alias module:model/RiskPredictorCustom
   ...
   * @param map {module:model/RiskPredictorCustomAllOfMap} 
   */
  constructor(name, compactName, type, map) {
    RiskPredictorCommon.initialize(this, name, compactName, type);
    RiskPredictorCustom.initialize(this, name, compactName, type, map);
  }
   ...
   */
  static initialize(obj, name, compactName, type, map) {
    obj['name'] = name;
  ...
  /**
   * Constructs a <code>RiskPredictorCustom</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskPredictorCustom} obj Optional instance to populate.
   * @return {module:model/RiskPredictorCustom} The populated <code>RiskPredictorCustom</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RiskPredictorCustom();
      ...
      if (data.hasOwnProperty('map')) {
        obj['map'] = RiskPredictorCustomAllOfMap.constructFromObject(data['map']);
      }
    }
    return obj;
  }
  ...
  /**
   * Validates the JSON data with respect to <code>RiskPredictorCustom</code>.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskPredictorCustom</code>.
   */
  static validateJSON(data) {
    // check to make sure all required properties are present in the JSON string
    for (const property of RiskPredictorCustom.RequiredProperties) {
    ...
    if (data['map']) {
      // data not null
      RiskPredictorCustomAllOfMap.validateJSON(data['map']);
    }
    return true;
  }
}
RiskPredictorCustom.RequiredProperties = ["name", "compactName", "type", "map"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
RiskPredictorCustom.prototype['_links'] = undefined;

/**
 * A string that specifies the resource’s unique identifier.
 * @member {String} id
 */
RiskPredictorCustom.prototype['id'] = undefined;
 ...
 * @member {String} name
 */
RiskPredictorCustom.prototype['name'] = undefined;
...
export default RiskPredictorCustom;