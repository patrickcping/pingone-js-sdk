...
/**
 * The RiskPredictorBotDetection model module.
 * @module model/RiskPredictorBotDetection
 * @version 2023-06-29
 */
class RiskPredictorBotDetection {
  /**
   * Constructs a new <code>RiskPredictorBotDetection</code>.
   * @alias module:model/RiskPredictorBotDetection
  ...
  constructor(name, compactName, type) {
    ...
    RiskPredictorBotDetection.initialize(this, name, compactName, type);
  }
  ...
  /**
   * Constructs a <code>RiskPredictorBotDetection</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskPredictorBotDetection} obj Optional instance to populate.
   * @return {module:model/RiskPredictorBotDetection} The populated <code>RiskPredictorBotDetection</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RiskPredictorBotDetection();
  ...
  /**
   * Validates the JSON data with respect to <code>RiskPredictorBotDetection</code>.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskPredictorBotDetection</code>.
   */
  static validateJSON(data) {
    // check to make sure all required properties are present in the JSON string
    for (const property of RiskPredictorBotDetection.RequiredProperties) {
...
RiskPredictorBotDetection.RequiredProperties = ["name", "compactName", "type"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
RiskPredictorBotDetection.prototype['_links'] = undefined;

/**
 * A string that specifies the resource’s unique identifier.
 * @member {String} id
 */
RiskPredictorBotDetection.prototype['id'] = undefined;
 ...
 * @member {String} name
 */
RiskPredictorBotDetection.prototype['name'] = undefined;
 ...
 */
RiskPredictorBotDetection.prototype['compactName'] = undefined;

/**
 * @member {module:model/EnumPredictorType} type
 */
RiskPredictorBotDetection.prototype['type'] = undefined;

/**
 * A string type. This specifies the description of the risk predictor. Maximum length is 1024 characters.
 * @member {String} description
 */
RiskPredictorBotDetection.prototype['description'] = undefined;

/**
 * The time the resource was created.
 * @member {Date} createdAt
 */
RiskPredictorBotDetection.prototype['createdAt'] = undefined;

/**
 * The time the resource was updated.
 * @member {Date} updatedAt
 */
RiskPredictorBotDetection.prototype['updatedAt'] = undefined;

/**
 * Indicates whether PingOne Risk is licensed for the environment.
 * @member {Boolean} licensed
 */
RiskPredictorBotDetection.prototype['licensed'] = undefined;

/**
 * A boolean to indicate whether the predictor is deletable in the environment.
 * @member {Boolean} deletable
 */
RiskPredictorBotDetection.prototype['deletable'] = undefined;

/**
 * @member {module:model/RiskPredictorCommonDefault} default
 */
RiskPredictorBotDetection.prototype['default'] = undefined;

/**
 * @member {module:model/RiskPredictorCommonCondition} condition
 */
RiskPredictorBotDetection.prototype['condition'] = undefined;
...
export default RiskPredictorBotDetection;