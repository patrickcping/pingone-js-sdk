...
/**
 * The RiskPredictorGeovelocity model module.
 * @module model/RiskPredictorGeovelocity
 * @version 2023-06-29
 */
class RiskPredictorGeovelocity {
  /**
   * Constructs a new <code>RiskPredictorGeovelocity</code>.
   * @alias module:model/RiskPredictorGeovelocity
  ...
  constructor(name, compactName, type) {
    ...
    RiskPredictorGeovelocity.initialize(this, name, compactName, type);
  }
  ...
  /**
   * Constructs a <code>RiskPredictorGeovelocity</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskPredictorGeovelocity} obj Optional instance to populate.
   * @return {module:model/RiskPredictorGeovelocity} The populated <code>RiskPredictorGeovelocity</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RiskPredictorGeovelocity();
  ...
  /**
   * Validates the JSON data with respect to <code>RiskPredictorGeovelocity</code>.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskPredictorGeovelocity</code>.
   */
  static validateJSON(data) {
    // check to make sure all required properties are present in the JSON string
    for (const property of RiskPredictorGeovelocity.RequiredProperties) {
...
RiskPredictorGeovelocity.RequiredProperties = ["name", "compactName", "type"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
RiskPredictorGeovelocity.prototype['_links'] = undefined;

/**
 * A string that specifies the resource’s unique identifier.
 * @member {String} id
 */
RiskPredictorGeovelocity.prototype['id'] = undefined;
 ...
 * @member {String} name
 */
RiskPredictorGeovelocity.prototype['name'] = undefined;
...
export default RiskPredictorGeovelocity;