...
export default class RiskPoliciesApi {
  ...
  */
  ...
  createRiskPolicySetWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/riskPolicySets', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createRiskPolicySet(environmentID, opts) {
    return this.createRiskPolicySetWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteRiskPolicySetWithHttpInfo(environmentID, riskPolicySetID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/riskPolicySets/{riskPolicySetID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteRiskPolicySet(environmentID, riskPolicySetID) {
    return this.deleteRiskPolicySetWithHttpInfo(environmentID, riskPolicySetID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneRiskPolicySetWithHttpInfo(environmentID, riskPolicySetID) {
    ...
    let accepts = ['application/json'];
    let returnType = RiskPolicySet;
    return this.apiClient.callApi('/environments/{environmentID}/riskPolicySets/{riskPolicySetID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneRiskPolicySet(environmentID, riskPolicySetID) {
    return this.readOneRiskPolicySetWithHttpInfo(environmentID, riskPolicySetID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readRiskPolicySetsWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/riskPolicySets', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readRiskPolicySets(environmentID) {
    return this.readRiskPolicySetsWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateRiskPolicySetWithHttpInfo(environmentID, riskPolicySetID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = RiskPolicySet;
    return this.apiClient.callApi('/environments/{environmentID}/riskPolicySets/{riskPolicySetID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateRiskPolicySet(environmentID, riskPolicySetID, opts) {
    return this.updateRiskPolicySetWithHttpInfo(environmentID, riskPolicySetID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}