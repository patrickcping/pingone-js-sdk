...
/**
 * The RiskPredictorIPReputation model module.
 * @module model/RiskPredictorIPReputation
 * @version 2023-06-29
 */
class RiskPredictorIPReputation {
    /**
     * Constructs a new <code>RiskPredictorIPReputation</code>.
     * @alias module:model/RiskPredictorIPReputation
    ...
    constructor(name, compactName, type) { 
        ...
        RiskPredictorIPReputation.initialize(this, name, compactName, type);
    }
    ...
    /**
     * Constructs a <code>RiskPredictorIPReputation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RiskPredictorIPReputation} obj Optional instance to populate.
     * @return {module:model/RiskPredictorIPReputation} The populated <code>RiskPredictorIPReputation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RiskPredictorIPReputation();
    ...
    /**
     * Validates the JSON data with respect to <code>RiskPredictorIPReputation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskPredictorIPReputation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RiskPredictorIPReputation.RequiredProperties) {
...
RiskPredictorIPReputation.RequiredProperties = ["name", "compactName", "type"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
RiskPredictorIPReputation.prototype['_links'] = undefined;

/**
 * A string that specifies the resource’s unique identifier.
 * @member {String} id
 */
RiskPredictorIPReputation.prototype['id'] = undefined;
 ...
 * @member {String} name
 */
RiskPredictorIPReputation.prototype['name'] = undefined;
...
export default RiskPredictorIPReputation;
