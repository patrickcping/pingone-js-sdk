...
/**
 * The RiskPredictorAnonymousNetwork model module.
 * @module model/RiskPredictorAnonymousNetwork
 * @version 2023-06-29
 */
class RiskPredictorAnonymousNetwork {
    /**
     * Constructs a new <code>RiskPredictorAnonymousNetwork</code>.
     * @alias module:model/RiskPredictorAnonymousNetwork
    ...
    constructor(name, compactName, type) { 
        ...
        RiskPredictorAnonymousNetwork.initialize(this, name, compactName, type);
    }
    ...
    /**
     * Constructs a <code>RiskPredictorAnonymousNetwork</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RiskPredictorAnonymousNetwork} obj Optional instance to populate.
     * @return {module:model/RiskPredictorAnonymousNetwork} The populated <code>RiskPredictorAnonymousNetwork</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RiskPredictorAnonymousNetwork();
    ...
    /**
     * Validates the JSON data with respect to <code>RiskPredictorAnonymousNetwork</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskPredictorAnonymousNetwork</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RiskPredictorAnonymousNetwork.RequiredProperties) {
...
RiskPredictorAnonymousNetwork.RequiredProperties = ["name", "compactName", "type"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
RiskPredictorAnonymousNetwork.prototype['_links'] = undefined;

/**
 * A string that specifies the resource’s unique identifier.
 * @member {String} id
 */
RiskPredictorAnonymousNetwork.prototype['id'] = undefined;
 ...
 * @member {String} name
 */
RiskPredictorAnonymousNetwork.prototype['name'] = undefined;
 ...
 */
RiskPredictorAnonymousNetwork.prototype['compactName'] = undefined;

/**
 * @member {module:model/EnumPredictorType} type
 */
RiskPredictorAnonymousNetwork.prototype['type'] = undefined;

/**
 * A string type. This specifies the description of the risk predictor. Maximum length is 1024 characters.
 * @member {String} description
 */
RiskPredictorAnonymousNetwork.prototype['description'] = undefined;

/**
 * The time the resource was created.
 * @member {Date} createdAt
 */
RiskPredictorAnonymousNetwork.prototype['createdAt'] = undefined;

/**
 * The time the resource was updated.
 * @member {Date} updatedAt
 */
RiskPredictorAnonymousNetwork.prototype['updatedAt'] = undefined;

/**
 * Indicates whether PingOne Risk is licensed for the environment.
 * @member {Boolean} licensed
 */
RiskPredictorAnonymousNetwork.prototype['licensed'] = undefined;

/**
 * A boolean to indicate whether the predictor is deletable in the environment.
 * @member {Boolean} deletable
 */
RiskPredictorAnonymousNetwork.prototype['deletable'] = undefined;

/**
 * @member {module:model/RiskPredictorCommonDefault} default
 */
RiskPredictorAnonymousNetwork.prototype['default'] = undefined;

/**
 * @member {module:model/RiskPredictorCommonCondition} condition
 */
RiskPredictorAnonymousNetwork.prototype['condition'] = undefined;

/**
 * A list of IP addresses (CIDRs) that are ignored for the predictor results.
 * @member {Array.<String>} whiteList
 */
RiskPredictorAnonymousNetwork.prototype['whiteList'] = undefined;
...
export default RiskPredictorAnonymousNetwork;
