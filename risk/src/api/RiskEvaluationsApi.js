    ...
    */
    ...
    createRiskEvaluationWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/riskEvaluations', 'POST',
    ...
    createRiskEvaluation(environmentID, opts) {
      return this.createRiskEvaluationWithHttpInfo(environmentID, opts)
    ...
    readOneRiskEvaluationWithHttpInfo(environmentID, riskEvaluationID) {
      ...
      let returnType = RiskEvaluation;
      return this.apiClient.callApi(
        '/environments/{environmentID}/riskEvaluations/{riskEvaluationID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneRiskEvaluation(environmentID, riskEvaluationID) {
      return this.readOneRiskEvaluationWithHttpInfo(environmentID, riskEvaluationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateRiskEvaluationWithHttpInfo(environmentID, riskEvaluationID, opts) {
      ...
      let returnType = RiskEvaluation;
      return this.apiClient.callApi(
        '/environments/{environmentID}/riskEvaluations/{riskEvaluationID}/event', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateRiskEvaluation(environmentID, riskEvaluationID, opts) {
      return this.updateRiskEvaluationWithHttpInfo(environmentID, riskEvaluationID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
