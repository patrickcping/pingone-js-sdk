...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneMfa.P1Error();
  });
  ...
  describe('P1Error', function() {
    it('should create an instance of P1Error', function() {
      ...
      //var instance = new PingOnePlatformApiPingOneMfa.P1Error();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneMfa.P1Error);
    });
