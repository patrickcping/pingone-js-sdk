...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneMfa.DeviceAuthenticationPolicy();
  });
  ...
  describe('DeviceAuthenticationPolicy', function() {
    it('should create an instance of DeviceAuthenticationPolicy', function() {
      // uncomment below and update the code to test DeviceAuthenticationPolicy
      //var instance = new PingOnePlatformApiPingOneMfa.DeviceAuthenticationPolicy();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneMfa.DeviceAuthenticationPolicy);
    });
