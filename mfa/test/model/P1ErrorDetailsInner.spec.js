...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneMfa.P1ErrorDetailsInner();
  });
  ...
  describe('P1ErrorDetailsInner', function() {
    it('should create an instance of P1ErrorDetailsInner', function() {
      ...
      //var instance = new PingOnePlatformApiPingOneMfa.P1ErrorDetailsInner();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneMfa.P1ErrorDetailsInner);
    });
