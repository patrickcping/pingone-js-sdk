...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneMfa.DeviceAuthenticationPolicyPost();
  });
  ...
  describe('DeviceAuthenticationPolicyPost', function() {
    it('should create an instance of DeviceAuthenticationPolicyPost', function() {
      // uncomment below and update the code to test DeviceAuthenticationPolicyPost
      //var instance = new PingOnePlatformApiPingOneMfa.DeviceAuthenticationPolicyPost();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneMfa.DeviceAuthenticationPolicyPost);
    });
