...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneMfa.FIDO2PolicyMdsAuthenticatorsRequirements();
  });
  ...
  describe('FIDO2PolicyMdsAuthenticatorsRequirements', function() {
    it('should create an instance of FIDO2PolicyMdsAuthenticatorsRequirements', function() {
      // uncomment below and update the code to test FIDO2PolicyMdsAuthenticatorsRequirements
      //var instance = new PingOnePlatformApiPingOneMfa.FIDO2PolicyMdsAuthenticatorsRequirements();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneMfa.FIDO2PolicyMdsAuthenticatorsRequirements);
    });
