...
export default class FIDODeviceApi {
  ...
  */
  ...
  createFidoDeviceWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/fidoDevicesMetadata', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createFidoDevice(environmentID, opts) {
    return this.createFidoDeviceWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteFidoDeviceWithHttpInfo(environmentID, fidoDeviceID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/fidoDevicesMetadata/{fidoDeviceID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteFidoDevice(environmentID, fidoDeviceID) {
    return this.deleteFidoDeviceWithHttpInfo(environmentID, fidoDeviceID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readFidoDevicesWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/fidoDevicesMetadata', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readFidoDevices(environmentID) {
    return this.readFidoDevicesWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneFidoDeviceWithHttpInfo(environmentID, fidoDeviceID) {
    ...
    let accepts = ['application/json'];
    let returnType = Object;
    return this.apiClient.callApi('/environments/{environmentID}/fidoDevicesMetadata/{fidoDeviceID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneFidoDevice(environmentID, fidoDeviceID) {
    return this.readOneFidoDeviceWithHttpInfo(environmentID, fidoDeviceID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}