...
export default class FIDO2PolicyApi {
  ...
  */
  ...
  createFIDO2PolicyWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/fido2Policies', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createFIDO2Policy(environmentID, opts) {
    return this.createFIDO2PolicyWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteFIDO2PolicyWithHttpInfo(environmentID, fido2PolicyID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/fido2Policies/{fido2PolicyID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteFIDO2Policy(environmentID, fido2PolicyID) {
    return this.deleteFIDO2PolicyWithHttpInfo(environmentID, fido2PolicyID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readFIDO2PoliciesWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/fido2Policies', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readFIDO2Policies(environmentID) {
    return this.readFIDO2PoliciesWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneFIDO2PolicyWithHttpInfo(environmentID, fido2PolicyID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = FIDO2Policy;
    return this.apiClient.callApi('/environments/{environmentID}/fido2Policies/{fido2PolicyID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneFIDO2Policy(environmentID, fido2PolicyID, opts) {
    return this.readOneFIDO2PolicyWithHttpInfo(environmentID, fido2PolicyID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateFIDO2PolicyWithHttpInfo(environmentID, fido2PolicyID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = FIDO2Policy;
    return this.apiClient.callApi('/environments/{environmentID}/fido2Policies/{fido2PolicyID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateFIDO2Policy(environmentID, fido2PolicyID, opts) {
    return this.updateFIDO2PolicyWithHttpInfo(environmentID, fido2PolicyID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}