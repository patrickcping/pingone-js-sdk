...
class FIDO2Policy {
    ...
    static validateJSON(data) {
        ...
        if (data['backupEligibility']) { // data not null
        ...
        if (data['mdsAuthenticatorsRequirements']) { // data not null
        ...
        if (data['userDisplayNameAttributes']) { // data not null
        ...
        if (data['userVerification']) { // data not null
