...
class MFAPushCredentialRequest {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `MFAPushCredentialRequest` with oneOf schemas MFAPushCredentialAPNS, MFAPushCredentialFCM, MFAPushCredentialFCMHTTPV1, MFAPushCredentialHMS. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
