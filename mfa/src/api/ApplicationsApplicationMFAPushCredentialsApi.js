    ...
    */
    ...
    createMFAPushCredentialWithHttpInfo(environmentID, applicationID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/pushCredentials', 'POST',
    ...
    createMFAPushCredential(environmentID, applicationID, opts) {
      return this.createMFAPushCredentialWithHttpInfo(environmentID, applicationID, opts)
    ...
    deleteMFAPushCredentialWithHttpInfo(environmentID, applicationID, pushCredentialID, opts) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/pushCredentials/{pushCredentialID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteMFAPushCredential(environmentID, applicationID, pushCredentialID, opts) {
      return this.deleteMFAPushCredentialWithHttpInfo(environmentID, applicationID, pushCredentialID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllMFAPushCredentialsWithHttpInfo(environmentID, applicationID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/pushCredentials', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllMFAPushCredentials(environmentID, applicationID) {
      return this.readAllMFAPushCredentialsWithHttpInfo(environmentID, applicationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneMFAPushCredentialWithHttpInfo(environmentID, applicationID, pushCredentialID) {
      ...
      let returnType = MFAPushCredentialResponse;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/pushCredentials/{pushCredentialID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneMFAPushCredential(environmentID, applicationID, pushCredentialID) {
      return this.readOneMFAPushCredentialWithHttpInfo(environmentID, applicationID, pushCredentialID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateMFAPushCredentialWithHttpInfo(environmentID, applicationID, pushCredentialID, opts) {
      ...
      let returnType = MFAPushCredentialResponse;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/pushCredentials/{pushCredentialID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateMFAPushCredential(environmentID, applicationID, pushCredentialID, opts) {
      return this.updateMFAPushCredentialWithHttpInfo(environmentID, applicationID, pushCredentialID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
