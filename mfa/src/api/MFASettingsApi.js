    ...
    */
    ...
    readMFASettingsWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/mfaSettings', 'GET',
    ...
    readMFASettings(environmentID) {
      return this.readMFASettingsWithHttpInfo(environmentID)
    ...
    resetMFASettingsWithHttpInfo(environmentID) {
      ...
      let returnType = MFASettings;
      return this.apiClient.callApi(
        '/environments/{environmentID}/mfaSettings', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    resetMFASettings(environmentID) {
      return this.resetMFASettingsWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateMFASettingsWithHttpInfo(environmentID, opts) {
      ...
      let returnType = MFASettings;
      return this.apiClient.callApi(
        '/environments/{environmentID}/mfaSettings', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateMFASettings(environmentID, opts) {
      return this.updateMFASettingsWithHttpInfo(environmentID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
