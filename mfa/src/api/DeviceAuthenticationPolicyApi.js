    ...
    */
    ...
    createDeviceAuthenticationPoliciesWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/deviceAuthenticationPolicies', 'POST',
    ...
    createDeviceAuthenticationPolicies(environmentID, opts) {
      return this.createDeviceAuthenticationPoliciesWithHttpInfo(environmentID, opts)
    ...
    deleteDeviceAuthenticationPolicyWithHttpInfo(environmentID, deviceAuthenticationPolicyID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/deviceAuthenticationPolicies/{deviceAuthenticationPolicyID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteDeviceAuthenticationPolicy(environmentID, deviceAuthenticationPolicyID) {
      return this.deleteDeviceAuthenticationPolicyWithHttpInfo(environmentID, deviceAuthenticationPolicyID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readDeviceAuthenticationPoliciesWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/deviceAuthenticationPolicies', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readDeviceAuthenticationPolicies(environmentID) {
      return this.readDeviceAuthenticationPoliciesWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneDeviceAuthenticationPolicyWithHttpInfo(environmentID, deviceAuthenticationPolicyID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/deviceAuthenticationPolicies/{deviceAuthenticationPolicyID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneDeviceAuthenticationPolicy(environmentID, deviceAuthenticationPolicyID) {
      return this.readOneDeviceAuthenticationPolicyWithHttpInfo(environmentID, deviceAuthenticationPolicyID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateDeviceAuthenticationPolicyWithHttpInfo(environmentID, deviceAuthenticationPolicyID, opts) {
      ...
      let returnType = DeviceAuthenticationPolicy;
      return this.apiClient.callApi(
        '/environments/{environmentID}/deviceAuthenticationPolicies/{deviceAuthenticationPolicyID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateDeviceAuthenticationPolicy(environmentID, deviceAuthenticationPolicyID, opts) {
      return this.updateDeviceAuthenticationPolicyWithHttpInfo(environmentID, deviceAuthenticationPolicyID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
