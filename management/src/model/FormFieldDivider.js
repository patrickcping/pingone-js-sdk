...
/**
 * The FormFieldDivider model module.
 * @module model/FormFieldDivider
 * @version 2023-06-29
 */
class FormFieldDivider {
    /**
     * Constructs a new <code>FormFieldDivider</code>.
     * @alias module:model/FormFieldDivider
    ...
    constructor(type, position) { 
        ...
        FormFieldDivider.initialize(this, type, position);
    }
    ...
    /**
     * Constructs a <code>FormFieldDivider</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormFieldDivider} obj Optional instance to populate.
     * @return {module:model/FormFieldDivider} The populated <code>FormFieldDivider</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormFieldDivider();
    ...
    /**
     * Validates the JSON data with respect to <code>FormFieldDivider</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormFieldDivider</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FormFieldDivider.RequiredProperties) {
...
FormFieldDivider.RequiredProperties = ["type", "position"];

/**
 * @member {module:model/EnumFormFieldType} type
 */
FormFieldDivider.prototype['type'] = undefined;

/**
 * @member {module:model/FormFieldCommonPosition} position
 */
FormFieldDivider.prototype['position'] = undefined;

/**
 * A string that specifies the field content.
 * @member {String} content
 */
FormFieldDivider.prototype['content'] = undefined;
