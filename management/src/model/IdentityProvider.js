...
class IdentityProvider {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `IdentityProvider` with oneOf schemas IdentityProviderApple, IdentityProviderClientIDClientSecret, IdentityProviderFacebook, IdentityProviderOIDC, IdentityProviderPaypal, IdentityProviderSAML. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
