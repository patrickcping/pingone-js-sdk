...
class UpdateApplicationRequest {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `UpdateApplicationRequest` with oneOf schemas ApplicationExternalLink, ApplicationOIDC, ApplicationPingOnePortal, ApplicationPingOneSelfService, ApplicationSAML, ApplicationWSFED. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
