...
class EntityArrayEmbeddedAttributesInner {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `EntityArrayEmbeddedAttributesInner` with oneOf schemas ApplicationAttributeMapping, IdentityProviderAttribute, ResourceAttribute, SchemaAttribute. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
