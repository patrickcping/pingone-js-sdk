...
class License {
    ...
    static validateJSON(data) {
        ...
        if (data['intelligence']) { // data not null
        ...
        if (data['orchestrate']) { // data not null
