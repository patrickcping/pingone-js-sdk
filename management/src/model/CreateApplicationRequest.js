...
class CreateApplicationRequest {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateApplicationRequest` with oneOf schemas ApplicationExternalLink, ApplicationOIDC, ApplicationSAML, ApplicationWSFED. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
