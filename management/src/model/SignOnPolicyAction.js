...
class SignOnPolicyAction {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SignOnPolicyAction` with oneOf schemas SignOnPolicyActionAgreement, SignOnPolicyActionCommon, SignOnPolicyActionIDFirst, SignOnPolicyActionIDP, SignOnPolicyActionLogin, SignOnPolicyActionMFA, SignOnPolicyActionPingIDWinLoginPasswordless, SignOnPolicyActionProgressiveProfiling. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
