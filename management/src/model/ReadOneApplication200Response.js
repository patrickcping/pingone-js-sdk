...
class ReadOneApplication200Response {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ReadOneApplication200Response` with oneOf schemas ApplicationExternalLink, ApplicationOIDC, ApplicationPingOneAdminConsole, ApplicationPingOnePortal, ApplicationPingOneSelfService, ApplicationSAML, ApplicationWSFED. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
