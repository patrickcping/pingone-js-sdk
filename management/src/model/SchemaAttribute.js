...
class SchemaAttribute {
     ...
     * @param enabled {Boolean} A boolean that specifies whether or not the attribute is enabled. This is a required property for POST and PUT operations; it cannot be omitted or explicitly set to null. Disabled attributes are ignored on create/update and not returned on read.
     * @param name {String} A string that specifies the name of the attribute. The attribute name must be provided during creation, must not be empty and must not exceed 256 characters. It must also be unique within the schema for an environment. It must start with a letter and may be followed by letters, numbers or hyphens.
     * @param type {module:model/EnumSchemaAttributeType} 
     */
    constructor(enabled, name, type) { 
        
        SchemaAttribute.initialize(this, enabled, name, type);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ldapAttribute')) {
                obj['ldapAttribute'] = ApiClient.convertToType(data['ldapAttribute'], 'String');
            }
            ...
            if (data.hasOwnProperty('schema')) {
                obj['schema'] = SchemaAttributeSchema.constructFromObject(data['schema']);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ldapAttribute'] && !(typeof data['ldapAttribute'] === 'string' || data['ldapAttribute'] instanceof String)) {
            throw new Error("Expected the field `ldapAttribute` to be a primitive type in the JSON string but got " + data['ldapAttribute']);
        }
        // ensure the json data is a string
        ...
        if (data['schema']) { // data not null
          SchemaAttributeSchema.validateJSON(data['schema']);
        }
        ...
        if (data['enumeratedValues']) { // data not null
            // ensure the json data is an array
        ...
        if (data['regexValidation']) { // data not null
...
SchemaAttribute.RequiredProperties = ["enabled", "name", "type"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
SchemaAttribute.prototype['_links'] = undefined;
 ...
 */
SchemaAttribute.prototype['displayName'] = undefined;
 ...
 */
SchemaAttribute.prototype['enabled'] = undefined;

/**
 * @member {module:model/ObjectEnvironment} environment
 */
SchemaAttribute.prototype['environment'] = undefined;

/**
 * A string that specifies the resource’s unique identifier.
 * @member {String} id
 */
SchemaAttribute.prototype['id'] = undefined;

/**
 * A string that specifies the LDAP attribute.
 * @member {String} ldapAttribute
 */
SchemaAttribute.prototype['ldapAttribute'] = undefined;
 ...
 */
SchemaAttribute.prototype['schemaType'] = undefined;
 ...
 */
SchemaAttribute.prototype['unique'] = undefined;
 ...
 */
SchemaAttribute.prototype['enumeratedValues'] = undefined;

/**
 * @member {module:model/SchemaAttributeRegexValidation} regexValidation
 */
SchemaAttribute.prototype['regexValidation'] = undefined;
