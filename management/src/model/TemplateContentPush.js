...
/**
 * The TemplateContentPush model module.
 * @module model/TemplateContentPush
 * @version 2023-06-29
 */
class TemplateContentPush {
    /**
     * Constructs a new <code>TemplateContentPush</code>.
     * @alias module:model/TemplateContentPush
     ...
     * @param title {String} The push title (maximum 200 characters). If supported, this can include variables.
     * @param body {String} The push text (maximum 400 characters for push text). If supported, this can include variables.
     */
    constructor(locale, deliveryMethod, title, body) { 
        TemplateContentCommon.initialize(this, locale, deliveryMethod);
        TemplateContentPush.initialize(this, locale, deliveryMethod, title, body);
    }
     ...
     */
    static initialize(obj, locale, deliveryMethod, title, body) { 
        obj['locale'] = locale;
    ...
    /**
     * Constructs a <code>TemplateContentPush</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateContentPush} obj Optional instance to populate.
     * @return {module:model/TemplateContentPush} The populated <code>TemplateContentPush</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateContentPush();
            ...
            if (data.hasOwnProperty('pushCategory')) {
                obj['pushCategory'] = EnumTemplateContentPushCategory.constructFromObject(data['pushCategory']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateContentPush</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateContentPush</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateContentPush.RequiredProperties) {
...
TemplateContentPush.RequiredProperties = ["locale", "deliveryMethod", "title", "body"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
TemplateContentPush.prototype['_links'] = undefined;

/**
 * The template id.
 * @member {String} id
 */
TemplateContentPush.prototype['id'] = undefined;

/**
 * The time the resource was created.
 * @member {String} createdAt
 */
TemplateContentPush.prototype['createdAt'] = undefined;

/**
 * The time the resource was last updated.
 * @member {String} updatedAt
 */
TemplateContentPush.prototype['updatedAt'] = undefined;

/**
 * Specifies whether the template is a predefined default template.
 * @member {Boolean} default
 */
TemplateContentPush.prototype['default'] = undefined;

/**
 * A valid case-insensitive locale, complying with the ISO-639 language code and ISO-3166 country code standards: Two-character language code, for example, \"en\". Two-character language code followed by a two-character country code, separated by an underscore or dash, for example: \"en_GB\", \"en-GB\". Cannot be changed after it is initially set in `POST /environments/{{envID}}/templates/{{templateName}}/contents`. 
 * @member {String} locale
 */
TemplateContentPush.prototype['locale'] = undefined;

/**
 * @member {module:model/EnumTemplateContentDeliveryMethod} deliveryMethod
 */
TemplateContentPush.prototype['deliveryMethod'] = undefined;
...
export default TemplateContentPush;
