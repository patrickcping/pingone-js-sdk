    ...
    */
    ...
    createPasswordPolicyWithHttpInfo(environmentID, passwordPolicy) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/passwordPolicies', 'POST',
    ...
    createPasswordPolicy(environmentID, passwordPolicy) {
      return this.createPasswordPolicyWithHttpInfo(environmentID, passwordPolicy)
    ...
    deletePasswordPolicyWithHttpInfo(environmentID, passwordPolicyID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/passwordPolicies/{passwordPolicyID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deletePasswordPolicy(environmentID, passwordPolicyID) {
      return this.deletePasswordPolicyWithHttpInfo(environmentID, passwordPolicyID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllPasswordPoliciesWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/passwordPolicies', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllPasswordPolicies(environmentID) {
      return this.readAllPasswordPoliciesWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOnePasswordPolicyWithHttpInfo(environmentID, passwordPolicyID) {
      ...
      let returnType = PasswordPolicy;
      return this.apiClient.callApi(
        '/environments/{environmentID}/passwordPolicies/{passwordPolicyID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOnePasswordPolicy(environmentID, passwordPolicyID) {
      return this.readOnePasswordPolicyWithHttpInfo(environmentID, passwordPolicyID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updatePasswordPolicyWithHttpInfo(environmentID, passwordPolicyID, opts) {
      ...
      let returnType = PasswordPolicy;
      return this.apiClient.callApi(
        '/environments/{environmentID}/passwordPolicies/{passwordPolicyID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updatePasswordPolicy(environmentID, passwordPolicyID, opts) {
      return this.updatePasswordPolicyWithHttpInfo(environmentID, passwordPolicyID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
