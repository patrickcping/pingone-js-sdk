    ...
    */
    ...
    createApplicationWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications', 'POST',
    ...
    createApplication(environmentID, opts) {
      return this.createApplicationWithHttpInfo(environmentID, opts)
    ...
    deleteApplicationWithHttpInfo(environmentID, applicationID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteApplication(environmentID, applicationID) {
      return this.deleteApplicationWithHttpInfo(environmentID, applicationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllApplicationsWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllApplications(environmentID) {
      return this.readAllApplicationsWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneApplicationWithHttpInfo(environmentID, applicationID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneApplication(environmentID, applicationID) {
      return this.readOneApplicationWithHttpInfo(environmentID, applicationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateApplicationWithHttpInfo(environmentID, applicationID, opts) {
      ...
      let returnType = ReadOneApplication200Response;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateApplication(environmentID, applicationID, opts) {
      return this.updateApplicationWithHttpInfo(environmentID, applicationID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
