    ...
    */
    ...
    createSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/signOnPolicyAssignments', 'POST',
    ...
    createSignOnPolicyAssignment(environmentID, applicationID, opts) {
      return this.createSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, opts)
    ...
    deleteSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, sOPAssignmentID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/signOnPolicyAssignments/{SOPAssignmentID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteSignOnPolicyAssignment(environmentID, applicationID, sOPAssignmentID) {
      return this.deleteSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, sOPAssignmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllSignOnPolicyAssignmentsWithHttpInfo(environmentID, applicationID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/signOnPolicyAssignments', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllSignOnPolicyAssignments(environmentID, applicationID) {
      return this.readAllSignOnPolicyAssignmentsWithHttpInfo(environmentID, applicationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, sOPAssignmentID) {
      ...
      let returnType = SignOnPolicyAssignment;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/signOnPolicyAssignments/{SOPAssignmentID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneSignOnPolicyAssignment(environmentID, applicationID, sOPAssignmentID) {
      return this.readOneSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, sOPAssignmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, sOPAssignmentID, opts) {
      ...
      let returnType = SignOnPolicyAssignment;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/signOnPolicyAssignments/{SOPAssignmentID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateSignOnPolicyAssignment(environmentID, applicationID, sOPAssignmentID, opts) {
      return this.updateSignOnPolicyAssignmentWithHttpInfo(environmentID, applicationID, sOPAssignmentID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
