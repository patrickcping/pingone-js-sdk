    ...
    */
    ...
    createLanguageWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages', 'POST',
    ...
    createLanguage(environmentID, opts) {
      return this.createLanguageWithHttpInfo(environmentID, opts)
    ...
    deleteLanguageWithHttpInfo(environmentID, languageID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteLanguage(environmentID, languageID) {
      return this.deleteLanguageWithHttpInfo(environmentID, languageID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readLanguagesWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readLanguages(environmentID) {
      return this.readLanguagesWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneLanguageWithHttpInfo(environmentID, languageID) {
      ...
      let returnType = Language;
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneLanguage(environmentID, languageID) {
      return this.readOneLanguageWithHttpInfo(environmentID, languageID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateLanguageWithHttpInfo(environmentID, languageID, opts) {
      ...
      let returnType = Language;
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateLanguage(environmentID, languageID, opts) {
      return this.updateLanguageWithHttpInfo(environmentID, languageID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
