    ...
    */
    ...
    createBrandingThemeWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/themes', 'POST',
    ...
    createBrandingTheme(environmentID, opts) {
      return this.createBrandingThemeWithHttpInfo(environmentID, opts)
    ...
    deleteBrandingThemeWithHttpInfo(environmentID, themeID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/themes/{themeID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteBrandingTheme(environmentID, themeID) {
      return this.deleteBrandingThemeWithHttpInfo(environmentID, themeID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readBrandingThemeDefaultWithHttpInfo(environmentID, themeID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/themes/{themeID}/default', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readBrandingThemeDefault(environmentID, themeID) {
      return this.readBrandingThemeDefaultWithHttpInfo(environmentID, themeID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readBrandingThemesWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/themes', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readBrandingThemes(environmentID) {
      return this.readBrandingThemesWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneBrandingThemeWithHttpInfo(environmentID, themeID) {
      ...
      let returnType = BrandingTheme;
      return this.apiClient.callApi(
        '/environments/{environmentID}/themes/{themeID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneBrandingTheme(environmentID, themeID) {
      return this.readOneBrandingThemeWithHttpInfo(environmentID, themeID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateBrandingThemeWithHttpInfo(environmentID, themeID, opts) {
      ...
      let returnType = BrandingTheme;
      return this.apiClient.callApi(
        '/environments/{environmentID}/themes/{themeID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateBrandingTheme(environmentID, themeID, opts) {
      return this.updateBrandingThemeWithHttpInfo(environmentID, themeID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateBrandingThemeDefaultWithHttpInfo(environmentID, themeID, opts) {
      ...
      let returnType = BrandingThemeDefault;
      return this.apiClient.callApi(
        '/environments/{environmentID}/themes/{themeID}/default', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateBrandingThemeDefault(environmentID, themeID, opts) {
      return this.updateBrandingThemeDefaultWithHttpInfo(environmentID, themeID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
