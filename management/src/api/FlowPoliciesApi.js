    ...
    */
    ...
    readAllFlowPoliciesWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/flowPolicies', 'GET',
    ...
    readAllFlowPolicies(environmentID, opts) {
      return this.readAllFlowPoliciesWithHttpInfo(environmentID, opts)
    ...
    readOneFlowPolicyWithHttpInfo(environmentID, flowPolicyID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/flowPolicies/{flowPolicyID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneFlowPolicy(environmentID, flowPolicyID) {
      return this.readOneFlowPolicyWithHttpInfo(environmentID, flowPolicyID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
