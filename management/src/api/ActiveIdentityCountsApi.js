    ...
    */
    ...
    environmentsEnvironmentIDActiveIdentityCountsGetWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/activeIdentityCounts', 'GET',
    ...
    environmentsEnvironmentIDActiveIdentityCountsGet(environmentID, opts) {
      return this.environmentsEnvironmentIDActiveIdentityCountsGetWithHttpInfo(environmentID, opts)
    ...
    environmentsEnvironmentIDMetricsActiveIdentityCountsGetWithHttpInfo(environmentID, opts) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/metrics/activeIdentityCounts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    environmentsEnvironmentIDMetricsActiveIdentityCountsGet(environmentID, opts) {
      return this.environmentsEnvironmentIDMetricsActiveIdentityCountsGetWithHttpInfo(environmentID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readActiveIdentityCountWithHttpInfo(organizationID, licenseID, opts) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/organizations/{organizationID}/licenses/{licenseID}/metrics/activeIdentityCounts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readActiveIdentityCount(organizationID, licenseID, opts) {
      return this.readActiveIdentityCountWithHttpInfo(organizationID, licenseID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
