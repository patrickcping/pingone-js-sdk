    ...
    */
    ...
    createResourceAttributeWithHttpInfo(environmentID, resourceID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/resources/{resourceID}/attributes', 'POST',
    ...
    createResourceAttribute(environmentID, resourceID, opts) {
      return this.createResourceAttributeWithHttpInfo(environmentID, resourceID, opts)
    ...
    deleteResourceAttributeWithHttpInfo(environmentID, resourceID, resourceAttrID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/resources/{resourceID}/attributes/{resourceAttrID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteResourceAttribute(environmentID, resourceID, resourceAttrID) {
      return this.deleteResourceAttributeWithHttpInfo(environmentID, resourceID, resourceAttrID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllResourceAttributesWithHttpInfo(environmentID, resourceID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/resources/{resourceID}/attributes', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllResourceAttributes(environmentID, resourceID) {
      return this.readAllResourceAttributesWithHttpInfo(environmentID, resourceID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneResourceAttributeWithHttpInfo(environmentID, resourceID, resourceAttrID) {
      ...
      let returnType = ResourceAttribute;
      return this.apiClient.callApi(
        '/environments/{environmentID}/resources/{resourceID}/attributes/{resourceAttrID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneResourceAttribute(environmentID, resourceID, resourceAttrID) {
      return this.readOneResourceAttributeWithHttpInfo(environmentID, resourceID, resourceAttrID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateResourceAttributeWithHttpInfo(environmentID, resourceID, resourceAttrID, opts) {
      ...
      let returnType = ResourceAttribute;
      return this.apiClient.callApi(
        '/environments/{environmentID}/resources/{resourceID}/attributes/{resourceAttrID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateResourceAttribute(environmentID, resourceID, resourceAttrID, opts) {
      return this.updateResourceAttributeWithHttpInfo(environmentID, resourceID, resourceAttrID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
