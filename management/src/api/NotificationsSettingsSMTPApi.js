    ...
    */
    ...
    deleteEmailDeliverySettingsWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/notificationsSettings/emailDeliverySettings', 'DELETE',
    ...
    deleteEmailDeliverySettings(environmentID) {
      return this.deleteEmailDeliverySettingsWithHttpInfo(environmentID)
    ...
    readEmailNotificationsSettingsWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/notificationsSettings/emailDeliverySettings', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readEmailNotificationsSettings(environmentID) {
      return this.readEmailNotificationsSettingsWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateEmailNotificationsSettingsWithHttpInfo(environmentID, opts) {
      ...
      let returnType = NotificationsSettingsEmailDeliverySettings;
      return this.apiClient.callApi(
        '/environments/{environmentID}/notificationsSettings/emailDeliverySettings', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateEmailNotificationsSettings(environmentID, opts) {
      return this.updateEmailNotificationsSettingsWithHttpInfo(environmentID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
