    ...
    */
    ...
    createUserRoleAssignmentWithHttpInfo(environmentID, userID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/roleAssignments', 'POST',
    ...
    createUserRoleAssignment(environmentID, userID, opts) {
      return this.createUserRoleAssignmentWithHttpInfo(environmentID, userID, opts)
    ...
    deleteUserRoleAssignmentWithHttpInfo(environmentID, userID, roleAssignmentID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/roleAssignments/{roleAssignmentID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteUserRoleAssignment(environmentID, userID, roleAssignmentID) {
      return this.deleteUserRoleAssignmentWithHttpInfo(environmentID, userID, roleAssignmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneUserRoleAssignmentWithHttpInfo(environmentID, userID, roleAssignmentID) {
      ...
      let returnType = RoleAssignment;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/roleAssignments/{roleAssignmentID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneUserRoleAssignment(environmentID, userID, roleAssignmentID) {
      return this.readOneUserRoleAssignmentWithHttpInfo(environmentID, userID, roleAssignmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readUserRoleAssignmentsWithHttpInfo(environmentID, userID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/roleAssignments', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readUserRoleAssignments(environmentID, userID) {
      return this.readUserRoleAssignmentsWithHttpInfo(environmentID, userID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
