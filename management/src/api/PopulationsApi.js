    ...
    */
    ...
    createPopulationWithHttpInfo(environmentID, population) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/populations', 'POST',
    ...
    createPopulation(environmentID, population) {
      return this.createPopulationWithHttpInfo(environmentID, population)
    ...
    deletePopulationWithHttpInfo(environmentID, populationID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/populations/{populationID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deletePopulation(environmentID, populationID) {
      return this.deletePopulationWithHttpInfo(environmentID, populationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllPopulationsWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/populations', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllPopulations(environmentID, opts) {
      return this.readAllPopulationsWithHttpInfo(environmentID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOnePopulationWithHttpInfo(environmentID, populationID) {
      ...
      let returnType = Population;
      return this.apiClient.callApi(
        '/environments/{environmentID}/populations/{populationID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOnePopulation(environmentID, populationID) {
      return this.readOnePopulationWithHttpInfo(environmentID, populationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOnePopulationDefaultIdpWithHttpInfo(environmentID, populationID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/populations/{populationID}/defaultIdentityProvider', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOnePopulationDefaultIdp(environmentID, populationID) {
      return this.readOnePopulationDefaultIdpWithHttpInfo(environmentID, populationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updatePopulationWithHttpInfo(environmentID, populationID, opts) {
      ...
      let returnType = Population;
      return this.apiClient.callApi(
        '/environments/{environmentID}/populations/{populationID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updatePopulation(environmentID, populationID, opts) {
      return this.updatePopulationWithHttpInfo(environmentID, populationID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updatePopulationDefaultIdpWithHttpInfo(environmentID, populationID, opts) {
      ...
      let returnType = PopulationDefaultIdp;
      return this.apiClient.callApi(
        '/environments/{environmentID}/populations/{populationID}/defaultIdentityProvider', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updatePopulationDefaultIdp(environmentID, populationID, opts) {
      return this.updatePopulationDefaultIdpWithHttpInfo(environmentID, populationID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
