    ...
    */
    ...
    createTrustedEmailAddressWithHttpInfo(environmentID, emailDomainID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/emailDomains/{emailDomainID}/trustedEmails', 'POST',
    ...
    createTrustedEmailAddress(environmentID, emailDomainID, opts) {
      return this.createTrustedEmailAddressWithHttpInfo(environmentID, emailDomainID, opts)
    ...
    deleteTrustedEmailAddressWithHttpInfo(environmentID, emailDomainID, trustedEmailId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/emailDomains/{emailDomainID}/trustedEmails/{trustedEmailId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteTrustedEmailAddress(environmentID, emailDomainID, trustedEmailId) {
      return this.deleteTrustedEmailAddressWithHttpInfo(environmentID, emailDomainID, trustedEmailId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllTrustedEmailAddressesWithHttpInfo(environmentID, emailDomainID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/emailDomains/{emailDomainID}/trustedEmails', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllTrustedEmailAddresses(environmentID, emailDomainID) {
      return this.readAllTrustedEmailAddressesWithHttpInfo(environmentID, emailDomainID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneTrustedEmailAddressWithHttpInfo(environmentID, emailDomainID, trustedEmailId) {
      ...
      let returnType = EmailDomainTrustedEmail;
      return this.apiClient.callApi(
        '/environments/{environmentID}/emailDomains/{emailDomainID}/trustedEmails/{trustedEmailId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneTrustedEmailAddress(environmentID, emailDomainID, trustedEmailId) {
      return this.readOneTrustedEmailAddressWithHttpInfo(environmentID, emailDomainID, trustedEmailId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    resendVerificationCodeToEmailWithHttpInfo(environmentID, emailDomainID, trustedEmailId, opts) {
      ...
      let returnType = EmailDomainTrustedEmail;
      return this.apiClient.callApi(
        '/environments/{environmentID}/emailDomains/{emailDomainID}/trustedEmails/{trustedEmailId}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    resendVerificationCodeToEmail(environmentID, emailDomainID, trustedEmailId, opts) {
      return this.resendVerificationCodeToEmailWithHttpInfo(environmentID, emailDomainID, trustedEmailId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
