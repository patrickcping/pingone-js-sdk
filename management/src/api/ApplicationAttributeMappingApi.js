    ...
    */
    ...
    createApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/attributes', 'POST',
    ...
    createApplicationAttributeMapping(environmentID, applicationID, opts) {
      return this.createApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, opts)
    ...
    deleteApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, attrMappingID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/attributes/{attrMappingID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteApplicationAttributeMapping(environmentID, applicationID, attrMappingID) {
      return this.deleteApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, attrMappingID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllApplicationAttributeMappingsWithHttpInfo(environmentID, applicationID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/attributes', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllApplicationAttributeMappings(environmentID, applicationID) {
      return this.readAllApplicationAttributeMappingsWithHttpInfo(environmentID, applicationID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, attrMappingID) {
      ...
      let returnType = ApplicationAttributeMapping;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/attributes/{attrMappingID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneApplicationAttributeMapping(environmentID, applicationID, attrMappingID) {
      return this.readOneApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, attrMappingID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, attrMappingID, opts) {
      ...
      let returnType = ApplicationAttributeMapping;
      return this.apiClient.callApi(
        '/environments/{environmentID}/applications/{applicationID}/attributes/{attrMappingID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateApplicationAttributeMapping(environmentID, applicationID, attrMappingID, opts) {
      return this.updateApplicationAttributeMappingWithHttpInfo(environmentID, applicationID, attrMappingID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
