...
export default class LicensesApi {
    ...
    */
    ...
    readAllLicenses(organizationID, opts) {
      return this.readAllLicensesWithHttpInfo(organizationID, opts)
    ...
    readOneLicense(organizationID, licenseID) {
      return this.readOneLicenseWithHttpInfo(organizationID, licenseID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneLicenseNameWithHttpInfo(organizationID, licenseID) {
      ...
      return this.apiClient.callApi(
        '/organizations/{organizationID}/licenses/{licenseID}/name', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneLicenseName(organizationID, licenseID) {
      return this.readOneLicenseNameWithHttpInfo(organizationID, licenseID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateOneLicenseNameWithHttpInfo(organizationID, licenseID, opts) {
      ...
      let returnType = LicenseName;
      return this.apiClient.callApi(
        '/organizations/{organizationID}/licenses/{licenseID}/name', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateOneLicenseName(organizationID, licenseID, opts) {
      return this.updateOneLicenseNameWithHttpInfo(organizationID, licenseID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
