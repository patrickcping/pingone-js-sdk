    ...
    */
    ...
    createSubscriptionWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/subscriptions', 'POST',
    ...
    createSubscription(environmentID, opts) {
      return this.createSubscriptionWithHttpInfo(environmentID, opts)
    ...
    deleteSubscriptionWithHttpInfo(environmentID, subscriptionID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/subscriptions/{subscriptionID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteSubscription(environmentID, subscriptionID) {
      return this.deleteSubscriptionWithHttpInfo(environmentID, subscriptionID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllSubscriptionsWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/subscriptions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllSubscriptions(environmentID) {
      return this.readAllSubscriptionsWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneSubscriptionWithHttpInfo(environmentID, subscriptionID) {
      ...
      let returnType = Subscription;
      return this.apiClient.callApi(
        '/environments/{environmentID}/subscriptions/{subscriptionID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneSubscription(environmentID, subscriptionID) {
      return this.readOneSubscriptionWithHttpInfo(environmentID, subscriptionID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateSubscriptionWithHttpInfo(environmentID, subscriptionID, opts) {
      ...
      let returnType = Subscription;
      return this.apiClient.callApi(
        '/environments/{environmentID}/subscriptions/{subscriptionID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateSubscription(environmentID, subscriptionID, opts) {
      return this.updateSubscriptionWithHttpInfo(environmentID, subscriptionID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
