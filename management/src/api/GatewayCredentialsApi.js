    ...
    */
    ...
    createGatewayCredentialWithHttpInfo(environmentID, gatewayID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/gateways/{gatewayID}/credentials', 'POST',
    ...
    createGatewayCredential(environmentID, gatewayID) {
      return this.createGatewayCredentialWithHttpInfo(environmentID, gatewayID)
    ...
    deleteGatewayCredentialWithHttpInfo(environmentID, gatewayID, credentialID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/gateways/{gatewayID}/credentials/{credentialID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteGatewayCredential(environmentID, gatewayID, credentialID) {
      return this.deleteGatewayCredentialWithHttpInfo(environmentID, gatewayID, credentialID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllGatewayCredentialsWithHttpInfo(environmentID, gatewayID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/gateways/{gatewayID}/credentials', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllGatewayCredentials(environmentID, gatewayID) {
      return this.readAllGatewayCredentialsWithHttpInfo(environmentID, gatewayID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneGatewayCredentialWithHttpInfo(environmentID, gatewayID, credentialID) {
      ...
      let returnType = GatewayCredential;
      return this.apiClient.callApi(
        '/environments/{environmentID}/gateways/{gatewayID}/credentials/{credentialID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneGatewayCredential(environmentID, gatewayID, credentialID) {
      return this.readOneGatewayCredentialWithHttpInfo(environmentID, gatewayID, credentialID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
