    ...
    */
    ...
    environmentsEnvironmentIDUsersUserIDSessionsGetWithHttpInfo(environmentID, userID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/sessions', 'GET',
    ...
    environmentsEnvironmentIDUsersUserIDSessionsGet(environmentID, userID) {
      return this.environmentsEnvironmentIDUsersUserIDSessionsGetWithHttpInfo(environmentID, userID)
    ...
    environmentsEnvironmentIDUsersUserIDSessionsSessionIDDeleteWithHttpInfo(environmentID, userID, sessionID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/sessions/{sessionID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    environmentsEnvironmentIDUsersUserIDSessionsSessionIDDelete(environmentID, userID, sessionID) {
      return this.environmentsEnvironmentIDUsersUserIDSessionsSessionIDDeleteWithHttpInfo(environmentID, userID, sessionID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    environmentsEnvironmentIDUsersUserIDSessionsSessionIDGetWithHttpInfo(environmentID, userID, sessionID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/sessions/{sessionID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    environmentsEnvironmentIDUsersUserIDSessionsSessionIDGet(environmentID, userID, sessionID) {
      return this.environmentsEnvironmentIDUsersUserIDSessionsSessionIDGetWithHttpInfo(environmentID, userID, sessionID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
