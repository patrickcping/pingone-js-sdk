    ...
    */
    ...
    createIdentityProviderWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/identityProviders', 'POST',
    ...
    createIdentityProvider(environmentID, opts) {
      return this.createIdentityProviderWithHttpInfo(environmentID, opts)
    ...
    deleteIdentityProviderWithHttpInfo(environmentID, providerID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/identityProviders/{providerID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteIdentityProvider(environmentID, providerID) {
      return this.deleteIdentityProviderWithHttpInfo(environmentID, providerID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllIdentityProvidersWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/identityProviders', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllIdentityProviders(environmentID) {
      return this.readAllIdentityProvidersWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneIdentityProviderWithHttpInfo(environmentID, providerID) {
      ...
      let returnType = IdentityProvider;
      return this.apiClient.callApi(
        '/environments/{environmentID}/identityProviders/{providerID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneIdentityProvider(environmentID, providerID) {
      return this.readOneIdentityProviderWithHttpInfo(environmentID, providerID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateIdentityProviderWithHttpInfo(environmentID, providerID, opts) {
      ...
      let returnType = IdentityProvider;
      return this.apiClient.callApi(
        '/environments/{environmentID}/identityProviders/{providerID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateIdentityProvider(environmentID, providerID, opts) {
      return this.updateIdentityProviderWithHttpInfo(environmentID, providerID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
