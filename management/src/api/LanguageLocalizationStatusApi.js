    ...
    */
    ...
    createLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}/status', 'POST',
    ...
    createLanguageLocalizationStatus(environmentID, languageID, opts) {
      return this.createLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, opts)
    ...
    deleteLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, l10nStatusID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}/status/{l10nStatusID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteLanguageLocalizationStatus(environmentID, languageID, l10nStatusID) {
      return this.deleteLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, l10nStatusID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readLanguageLocalizationStatusWithHttpInfo(environmentID, languageID) {
      ...
      let returnType = LanguageLocalizationStatus;
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}/status', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readLanguageLocalizationStatus(environmentID, languageID) {
      return this.readLanguageLocalizationStatusWithHttpInfo(environmentID, languageID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, l10nStatusID) {
      ...
      let returnType = LanguageLocalizationStatus;
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}/status/{l10nStatusID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneLanguageLocalizationStatus(environmentID, languageID, l10nStatusID) {
      return this.readOneLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, l10nStatusID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, l10nStatusID, opts) {
      ...
      let returnType = LanguageLocalizationStatus;
      return this.apiClient.callApi(
        '/environments/{environmentID}/languages/{languageID}/status/{l10nStatusID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateLanguageLocalizationStatus(environmentID, languageID, l10nStatusID, opts) {
      return this.updateLanguageLocalizationStatusWithHttpInfo(environmentID, languageID, l10nStatusID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
