    ...
    */
    ...
    createDomainWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/customDomains', 'POST',
    ...
    createDomain(environmentID, opts) {
      return this.createDomainWithHttpInfo(environmentID, opts)
    ...
    deleteDomainWithHttpInfo(environmentID, customDomainID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/customDomains/{customDomainID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteDomain(environmentID, customDomainID) {
      return this.deleteDomainWithHttpInfo(environmentID, customDomainID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllDomainsWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/customDomains', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllDomains(environmentID) {
      return this.readAllDomainsWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneDomainWithHttpInfo(environmentID, customDomainID) {
      ...
      let returnType = CustomDomain;
      return this.apiClient.callApi(
        '/environments/{environmentID}/customDomains/{customDomainID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneDomain(environmentID, customDomainID) {
      return this.readOneDomainWithHttpInfo(environmentID, customDomainID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateDomainWithHttpInfo(environmentID, customDomainID, opts) {
      ...
      let returnType = CustomDomain;
      return this.apiClient.callApi(
        '/environments/{environmentID}/customDomains/{customDomainID}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateDomain(environmentID, customDomainID, opts) {
      return this.updateDomainWithHttpInfo(environmentID, customDomainID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
