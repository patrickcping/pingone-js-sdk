...
export default class GatewaysApi {
  ...
  */
  ...
  createGatewayWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/gateways', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createGateway(environmentID, opts) {
    return this.createGatewayWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteGatewayWithHttpInfo(environmentID, gatewayID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteGateway(environmentID, gatewayID) {
    return this.deleteGatewayWithHttpInfo(environmentID, gatewayID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllGatewaysWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/gateways', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllGateways(environmentID) {
    return this.readAllGatewaysWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneGatewayWithHttpInfo(environmentID, gatewayID) {
    ...
    let accepts = ['application/json'];
    let returnType = CreateGateway201Response;
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneGateway(environmentID, gatewayID) {
    return this.readOneGatewayWithHttpInfo(environmentID, gatewayID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateGatewayWithHttpInfo(environmentID, gatewayID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = CreateGateway201Response;
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateGateway(environmentID, gatewayID, opts) {
    return this.updateGatewayWithHttpInfo(environmentID, gatewayID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}