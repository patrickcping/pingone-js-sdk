...
/**
* MFAPairingKeys service.
* @module api/MFAPairingKeysApi
* @version 2023-06-29
*/
export default class MFAPairingKeysApi {
  /**
  * Constructs a new MFAPairingKeysApi. 
  * @alias module:api/MFAPairingKeysApi
  * @class
  ...
  */
  ...
  environmentsEnvironmentIDUsersUserIDPairingKeysPairingKeyIDDeleteWithHttpInfo(environmentID, userID, pairingKeyID) {
    ...
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/pairingKeys/{pairingKeyID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDUsersUserIDPairingKeysPairingKeyIDDelete(environmentID, userID, pairingKeyID) {
    return this.environmentsEnvironmentIDUsersUserIDPairingKeysPairingKeyIDDeleteWithHttpInfo(environmentID, userID, pairingKeyID).then(function (response_and_data) {
  ...
  environmentsEnvironmentIDUsersUserIDPairingKeysPairingKeyIDGetWithHttpInfo(environmentID, userID, pairingKeyID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/pairingKeys/{pairingKeyID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDUsersUserIDPairingKeysPairingKeyIDGet(environmentID, userID, pairingKeyID) {
    return this.environmentsEnvironmentIDUsersUserIDPairingKeysPairingKeyIDGetWithHttpInfo(environmentID, userID, pairingKeyID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  environmentsEnvironmentIDUsersUserIDPairingKeysPostWithHttpInfo(environmentID, userID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/pairingKeys', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDUsersUserIDPairingKeysPost(environmentID, userID, opts) {
    return this.environmentsEnvironmentIDUsersUserIDPairingKeysPostWithHttpInfo(environmentID, userID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}