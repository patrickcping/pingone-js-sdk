...
export default class IdentityPropagationPlansApi {
  ...
  */
  ...
  createPlanWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/propagation/plans', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createPlan(environmentID, opts) {
    return this.createPlanWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deletePlanWithHttpInfo(environmentID, planID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/propagation/plans/{planID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deletePlan(environmentID, planID, opts) {
    return this.deletePlanWithHttpInfo(environmentID, planID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllPlansWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/propagation/plans', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllPlans(environmentID, opts) {
    return this.readAllPlansWithHttpInfo(environmentID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOnePlanWithHttpInfo(environmentID, planID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = IdentityPropagationPlan;
    return this.apiClient.callApi('/environments/{environmentID}/propagation/plans/{planID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOnePlan(environmentID, planID, opts) {
    return this.readOnePlanWithHttpInfo(environmentID, planID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updatePlanWithHttpInfo(environmentID, planID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = IdentityPropagationPlan;
    return this.apiClient.callApi('/environments/{environmentID}/propagation/plans/{planID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updatePlan(environmentID, planID, opts) {
    return this.updatePlanWithHttpInfo(environmentID, planID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}