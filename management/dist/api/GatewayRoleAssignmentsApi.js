...
export default class GatewayRoleAssignmentsApi {
  ...
  */
  ...
  createGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}/roleAssignments', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createGatewayRoleAssignment(environmentID, gatewayID, opts) {
    return this.createGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, opts).then(function (response_and_data) {
  ...
  deleteGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, gatewayRoleAssignmentID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}/roleAssignments/{gatewayRoleAssignmentID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteGatewayRoleAssignment(environmentID, gatewayID, gatewayRoleAssignmentID) {
    return this.deleteGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, gatewayRoleAssignmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readGatewayRoleAssignmentsWithHttpInfo(environmentID, gatewayID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}/roleAssignments', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readGatewayRoleAssignments(environmentID, gatewayID) {
    return this.readGatewayRoleAssignmentsWithHttpInfo(environmentID, gatewayID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, gatewayRoleAssignmentID) {
    ...
    let accepts = ['application/json'];
    let returnType = RoleAssignment;
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}/roleAssignments/{gatewayRoleAssignmentID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneGatewayRoleAssignment(environmentID, gatewayID, gatewayRoleAssignmentID) {
    return this.readOneGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, gatewayRoleAssignmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, gatewayRoleAssignmentID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = RoleAssignment;
    return this.apiClient.callApi('/environments/{environmentID}/gateways/{gatewayID}/roleAssignments/{gatewayRoleAssignmentID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateGatewayRoleAssignment(environmentID, gatewayID, gatewayRoleAssignmentID, opts) {
    return this.updateGatewayRoleAssignmentWithHttpInfo(environmentID, gatewayID, gatewayRoleAssignmentID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}