...
export default class IdentityProviderAttributesApi {
  ...
  */
  ...
  createIdentityProviderAttributeWithHttpInfo(environmentID, providerID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/identityProviders/{providerID}/attributes', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createIdentityProviderAttribute(environmentID, providerID, opts) {
    return this.createIdentityProviderAttributeWithHttpInfo(environmentID, providerID, opts).then(function (response_and_data) {
  ...
  deleteIdentityProviderAttributeWithHttpInfo(environmentID, providerID, providerAttributeID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/identityProviders/{providerID}/attributes/{providerAttributeID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteIdentityProviderAttribute(environmentID, providerID, providerAttributeID) {
    return this.deleteIdentityProviderAttributeWithHttpInfo(environmentID, providerID, providerAttributeID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllIdentityProviderAttributesWithHttpInfo(environmentID, providerID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/identityProviders/{providerID}/attributes', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllIdentityProviderAttributes(environmentID, providerID) {
    return this.readAllIdentityProviderAttributesWithHttpInfo(environmentID, providerID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneIdentityProviderAttributeWithHttpInfo(environmentID, providerID, providerAttributeID) {
    ...
    let accepts = ['application/json'];
    let returnType = IdentityProviderAttribute;
    return this.apiClient.callApi('/environments/{environmentID}/identityProviders/{providerID}/attributes/{providerAttributeID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneIdentityProviderAttribute(environmentID, providerID, providerAttributeID) {
    return this.readOneIdentityProviderAttributeWithHttpInfo(environmentID, providerID, providerAttributeID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateIdentityProviderAttributeWithHttpInfo(environmentID, providerID, providerAttributeID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = IdentityProviderAttribute;
    return this.apiClient.callApi('/environments/{environmentID}/identityProviders/{providerID}/attributes/{providerAttributeID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateIdentityProviderAttribute(environmentID, providerID, providerAttributeID, opts) {
    return this.updateIdentityProviderAttributeWithHttpInfo(environmentID, providerID, providerAttributeID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}