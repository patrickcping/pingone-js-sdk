...
export default class SignOnPolicyActionsApi {
  ...
  */
  ...
  createSignOnPolicyActionWithHttpInfo(environmentID, policyID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/signOnPolicies/{policyID}/actions', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createSignOnPolicyAction(environmentID, policyID, opts) {
    return this.createSignOnPolicyActionWithHttpInfo(environmentID, policyID, opts).then(function (response_and_data) {
  ...
  deleteSignOnPolicyActionWithHttpInfo(environmentID, policyID, actionID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/signOnPolicies/{policyID}/actions/{actionID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteSignOnPolicyAction(environmentID, policyID, actionID) {
    return this.deleteSignOnPolicyActionWithHttpInfo(environmentID, policyID, actionID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllSignOnPolicyActionsWithHttpInfo(environmentID, policyID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/signOnPolicies/{policyID}/actions', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllSignOnPolicyActions(environmentID, policyID) {
    return this.readAllSignOnPolicyActionsWithHttpInfo(environmentID, policyID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneSignOnPolicyActionWithHttpInfo(environmentID, policyID, actionID) {
    ...
    let accepts = ['application/json'];
    let returnType = SignOnPolicyAction;
    return this.apiClient.callApi('/environments/{environmentID}/signOnPolicies/{policyID}/actions/{actionID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneSignOnPolicyAction(environmentID, policyID, actionID) {
    return this.readOneSignOnPolicyActionWithHttpInfo(environmentID, policyID, actionID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateSignOnPolicyActionWithHttpInfo(environmentID, policyID, actionID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = SignOnPolicyAction;
    return this.apiClient.callApi('/environments/{environmentID}/signOnPolicies/{policyID}/actions/{actionID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateSignOnPolicyAction(environmentID, policyID, actionID, opts) {
    return this.updateSignOnPolicyActionWithHttpInfo(environmentID, policyID, actionID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}