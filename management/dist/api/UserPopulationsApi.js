...
export default class UserPopulationsApi {
  ...
  */
  ...
  readUserPopulationWithHttpInfo(environmentID, userID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/population', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readUserPopulation(environmentID, userID) {
    return this.readUserPopulationWithHttpInfo(environmentID, userID).then(function (response_and_data) {
  ...
  updateUserPopulationWithHttpInfo(environmentID, userID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = UserPopulation;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/population', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateUserPopulation(environmentID, userID, opts) {
    return this.updateUserPopulationWithHttpInfo(environmentID, userID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}