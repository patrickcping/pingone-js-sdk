...
export default class ResourceScopesApi {
  ...
  */
  ...
  createResourceScopeWithHttpInfo(environmentID, resourceID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}/scopes', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createResourceScope(environmentID, resourceID, opts) {
    return this.createResourceScopeWithHttpInfo(environmentID, resourceID, opts).then(function (response_and_data) {
  ...
  deleteResourceScopeWithHttpInfo(environmentID, resourceID, scopeID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}/scopes/{scopeID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteResourceScope(environmentID, resourceID, scopeID) {
    return this.deleteResourceScopeWithHttpInfo(environmentID, resourceID, scopeID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllResourceScopesWithHttpInfo(environmentID, resourceID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}/scopes', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllResourceScopes(environmentID, resourceID) {
    return this.readAllResourceScopesWithHttpInfo(environmentID, resourceID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneResourceScopeWithHttpInfo(environmentID, resourceID, scopeID) {
    ...
    let accepts = ['application/json'];
    let returnType = ResourceScope;
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}/scopes/{scopeID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneResourceScope(environmentID, resourceID, scopeID) {
    return this.readOneResourceScopeWithHttpInfo(environmentID, resourceID, scopeID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateResourceScopeWithHttpInfo(environmentID, resourceID, scopeID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = ResourceScope;
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}/scopes/{scopeID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateResourceScope(environmentID, resourceID, scopeID, opts) {
    return this.updateResourceScopeWithHttpInfo(environmentID, resourceID, scopeID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}