...
export default class ApplicationRoleAssignmentsApi {
  ...
  */
  ...
  createApplicationRoleAssignmentWithHttpInfo(environmentID, applicationID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/applications/{applicationID}/roleAssignments', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createApplicationRoleAssignment(environmentID, applicationID, opts) {
    return this.createApplicationRoleAssignmentWithHttpInfo(environmentID, applicationID, opts).then(function (response_and_data) {
  ...
  deleteApplicationRoleAssignmentWithHttpInfo(environmentID, applicationID, roleAssignmentID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/applications/{applicationID}/roleAssignments/{roleAssignmentID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteApplicationRoleAssignment(environmentID, applicationID, roleAssignmentID) {
    return this.deleteApplicationRoleAssignmentWithHttpInfo(environmentID, applicationID, roleAssignmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readApplicationRoleAssignmentsWithHttpInfo(environmentID, applicationID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/applications/{applicationID}/roleAssignments', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readApplicationRoleAssignments(environmentID, applicationID) {
    return this.readApplicationRoleAssignmentsWithHttpInfo(environmentID, applicationID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneApplicationRoleAssignmentWithHttpInfo(environmentID, applicationID, roleAssignmentID) {
    ...
    let accepts = ['application/json'];
    let returnType = RoleAssignment;
    return this.apiClient.callApi('/environments/{environmentID}/applications/{applicationID}/roleAssignments/{roleAssignmentID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneApplicationRoleAssignment(environmentID, applicationID, roleAssignmentID) {
    return this.readOneApplicationRoleAssignmentWithHttpInfo(environmentID, applicationID, roleAssignmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}