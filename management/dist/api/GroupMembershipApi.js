...
export default class GroupMembershipApi {
  ...
  */
  ...
  addUserToGroupWithHttpInfo(environmentID, userID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/memberOfGroups', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  addUserToGroup(environmentID, userID, opts) {
    return this.addUserToGroupWithHttpInfo(environmentID, userID, opts).then(function (response_and_data) {
  ...
  readAllGroupMembershipsForUserWithHttpInfo(environmentID, userID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/memberOfGroups', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllGroupMembershipsForUser(environmentID, userID, opts) {
    return this.readAllGroupMembershipsForUserWithHttpInfo(environmentID, userID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneGroupMembershipForUserWithHttpInfo(environmentID, userID, groupID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = GroupMembership;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/memberOfGroups/{groupID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneGroupMembershipForUser(environmentID, userID, groupID, opts) {
    return this.readOneGroupMembershipForUserWithHttpInfo(environmentID, userID, groupID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  removeUserFromGroupWithHttpInfo(environmentID, userID, groupID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/memberOfGroups/{groupID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  removeUserFromGroup(environmentID, userID, groupID) {
    return this.removeUserFromGroupWithHttpInfo(environmentID, userID, groupID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}