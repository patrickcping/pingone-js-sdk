...
export default class PropagationRevisionsApi {
  ...
  */
  ...
  environmentsEnvironmentIDPropagationRevisionsIdlatestGetWithHttpInfo(environmentID, opts) {
    ...
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/propagation/revisions/id:latest', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDPropagationRevisionsIdlatestGet(environmentID, opts) {
    return this.environmentsEnvironmentIDPropagationRevisionsIdlatestGetWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  environmentsEnvironmentIDPropagationRevisionsPostWithHttpInfo(environmentID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/propagation/revisions', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDPropagationRevisionsPost(environmentID) {
    return this.environmentsEnvironmentIDPropagationRevisionsPostWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  environmentsEnvironmentIDPropagationRevisionsPreviousRevisionIDGetWithHttpInfo(environmentID, previousRevisionID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/propagation/revisions/{previousRevisionID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDPropagationRevisionsPreviousRevisionIDGet(environmentID, previousRevisionID, opts) {
    return this.environmentsEnvironmentIDPropagationRevisionsPreviousRevisionIDGetWithHttpInfo(environmentID, previousRevisionID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}