...
export default class ResourcesApi {
  ...
  */
  ...
  createResourceWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/resources', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createResource(environmentID, opts) {
    return this.createResourceWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteResourceWithHttpInfo(environmentID, resourceID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteResource(environmentID, resourceID) {
    return this.deleteResourceWithHttpInfo(environmentID, resourceID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllResourcesWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/resources', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllResources(environmentID) {
    return this.readAllResourcesWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneResourceWithHttpInfo(environmentID, resourceID) {
    ...
    let accepts = ['application/json'];
    let returnType = Resource;
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneResource(environmentID, resourceID) {
    return this.readOneResourceWithHttpInfo(environmentID, resourceID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateResourceWithHttpInfo(environmentID, resourceID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = Resource;
    return this.apiClient.callApi('/environments/{environmentID}/resources/{resourceID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateResource(environmentID, resourceID, opts) {
    return this.updateResourceWithHttpInfo(environmentID, resourceID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}