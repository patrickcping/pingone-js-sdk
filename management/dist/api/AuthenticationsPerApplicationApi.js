...
export default class AuthenticationsPerApplicationApi {
  ...
  */
  ...
  environmentsEnvironmentIDApplicationSignonsGetWithHttpInfo(environmentID, opts) {
    ...
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/applicationSignons', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDApplicationSignonsGet(environmentID, opts) {
    return this.environmentsEnvironmentIDApplicationSignonsGetWithHttpInfo(environmentID, opts).then(function (response_and_data) {
