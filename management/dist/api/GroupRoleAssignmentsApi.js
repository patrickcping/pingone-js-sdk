...
export default class GroupRoleAssignmentsApi {
  ...
  */
  ...
  createGroupRoleAssignmentWithHttpInfo(environmentID, groupID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/groups/{groupID}/roleAssignments', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createGroupRoleAssignment(environmentID, groupID, opts) {
    return this.createGroupRoleAssignmentWithHttpInfo(environmentID, groupID, opts).then(function (response_and_data) {
  ...
  deleteGroupRoleAssignmentWithHttpInfo(environmentID, groupID, roleAssignmentID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/groups/{groupID}/roleAssignments/{roleAssignmentID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteGroupRoleAssignment(environmentID, groupID, roleAssignmentID) {
    return this.deleteGroupRoleAssignmentWithHttpInfo(environmentID, groupID, roleAssignmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readGroupRoleAssignmentsWithHttpInfo(environmentID, groupID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/groups/{groupID}/roleAssignments', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readGroupRoleAssignments(environmentID, groupID) {
    return this.readGroupRoleAssignmentsWithHttpInfo(environmentID, groupID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneGroupRoleAssignmentWithHttpInfo(environmentID, groupID, roleAssignmentID) {
    ...
    let accepts = ['application/json'];
    let returnType = RoleAssignment;
    return this.apiClient.callApi('/environments/{environmentID}/groups/{groupID}/roleAssignments/{roleAssignmentID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneGroupRoleAssignment(environmentID, groupID, roleAssignmentID) {
    return this.readOneGroupRoleAssignmentWithHttpInfo(environmentID, groupID, roleAssignmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}