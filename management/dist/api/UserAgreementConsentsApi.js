...
export default class UserAgreementConsentsApi {
  ...
  */
  ...
  environmentsEnvironmentIDUsersUserIDAgreementConsentsAgreementIDGetWithHttpInfo(environmentID, userID, agreementID) {
    ...
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/agreementConsents/{agreementID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDUsersUserIDAgreementConsentsAgreementIDGet(environmentID, userID, agreementID) {
    return this.environmentsEnvironmentIDUsersUserIDAgreementConsentsAgreementIDGetWithHttpInfo(environmentID, userID, agreementID).then(function (response_and_data) {
  ...
  environmentsEnvironmentIDUsersUserIDAgreementConsentsAgreementIDPostWithHttpInfo(environmentID, userID, agreementID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/agreementConsents/{agreementID}', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDUsersUserIDAgreementConsentsAgreementIDPost(environmentID, userID, agreementID, opts) {
    return this.environmentsEnvironmentIDUsersUserIDAgreementConsentsAgreementIDPostWithHttpInfo(environmentID, userID, agreementID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  environmentsEnvironmentIDUsersUserIDAgreementConsentsGetWithHttpInfo(environmentID, userID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/agreementConsents', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  environmentsEnvironmentIDUsersUserIDAgreementConsentsGet(environmentID, userID) {
    return this.environmentsEnvironmentIDUsersUserIDAgreementConsentsGetWithHttpInfo(environmentID, userID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}