...
export default class AgreementLanguagesResourcesApi {
  ...
  */
  ...
  createAgreementLanguageWithHttpInfo(environmentID, agreementID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/agreements/{agreementID}/languages', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createAgreementLanguage(environmentID, agreementID, opts) {
    return this.createAgreementLanguageWithHttpInfo(environmentID, agreementID, opts).then(function (response_and_data) {
  ...
  deleteAgreementLanguageWithHttpInfo(environmentID, agreementID, languageID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/agreements/{agreementID}/languages/{languageID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteAgreementLanguage(environmentID, agreementID, languageID) {
    return this.deleteAgreementLanguageWithHttpInfo(environmentID, agreementID, languageID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllAgreementLanguagesWithHttpInfo(environmentID, agreementID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/agreements/{agreementID}/languages', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllAgreementLanguages(environmentID, agreementID) {
    return this.readAllAgreementLanguagesWithHttpInfo(environmentID, agreementID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneAgreementLanguageWithHttpInfo(environmentID, agreementID, languageID) {
    ...
    let accepts = ['application/json'];
    let returnType = AgreementLanguage;
    return this.apiClient.callApi('/environments/{environmentID}/agreements/{agreementID}/languages/{languageID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneAgreementLanguage(environmentID, agreementID, languageID) {
    return this.readOneAgreementLanguageWithHttpInfo(environmentID, agreementID, languageID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateAgreementLanguageWithHttpInfo(environmentID, agreementID, languageID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = AgreementLanguage;
    return this.apiClient.callApi('/environments/{environmentID}/agreements/{agreementID}/languages/{languageID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateAgreementLanguage(environmentID, agreementID, languageID, opts) {
    return this.updateAgreementLanguageWithHttpInfo(environmentID, agreementID, languageID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}