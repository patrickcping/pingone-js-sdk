...
/**
 * The ApplicationExternalLink model module.
 * @module model/ApplicationExternalLink
 * @version 2023-06-29
 */
class ApplicationExternalLink {
  /**
   * Constructs a new <code>ApplicationExternalLink</code>.
   * @alias module:model/ApplicationExternalLink
   ...
   * @param homePageUrl {String} A string that specifies the custom home page URL for the application.
   */
  constructor(enabled, name, protocol, type, homePageUrl) {
    Application.initialize(this, enabled, name, protocol, type);
    ApplicationExternalLink.initialize(this, enabled, name, protocol, type, homePageUrl);
  }
   ...
   */
  static initialize(obj, enabled, name, protocol, type, homePageUrl) {
    obj['enabled'] = enabled;
    obj['name'] = name;
    obj['protocol'] = protocol;
    obj['type'] = type;
    obj['homePageUrl'] = homePageUrl;
  }

  /**
   * Constructs a <code>ApplicationExternalLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApplicationExternalLink} obj Optional instance to populate.
   * @return {module:model/ApplicationExternalLink} The populated <code>ApplicationExternalLink</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ApplicationExternalLink();
  ...
  /**
   * Validates the JSON data with respect to <code>ApplicationExternalLink</code>.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationExternalLink</code>.
   */
  static validateJSON(data) {
    // check to make sure all required properties are present in the JSON string
    for (const property of ApplicationExternalLink.RequiredProperties) {
...
ApplicationExternalLink.RequiredProperties = ["enabled", "name", "protocol", "type", "homePageUrl"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
ApplicationExternalLink.prototype['_links'] = undefined;

/**
 * @member {module:model/ApplicationAccessControl} accessControl
 */
ApplicationExternalLink.prototype['accessControl'] = undefined;

/**
 * The time the resource was created.
 * @member {Date} createdAt
 */
ApplicationExternalLink.prototype['createdAt'] = undefined;

/**
 * A string that specifies the description of the application.
 * @member {String} description
 */
ApplicationExternalLink.prototype['description'] = undefined;

/**
 * A string that specifies the current enabled state of the application. Options are ENABLED or DISABLED.
 * @member {Boolean} enabled
 */
ApplicationExternalLink.prototype['enabled'] = undefined;

/**
 * @member {module:model/ObjectEnvironment} environment
 */
ApplicationExternalLink.prototype['environment'] = undefined;
 ...
 */
ApplicationExternalLink.prototype['hiddenFromAppPortal'] = undefined;

/**
 * @member {module:model/ApplicationIcon} icon
 */
ApplicationExternalLink.prototype['icon'] = undefined;

/**
 * A string that specifies the application ID.
 * @member {String} id
 */
ApplicationExternalLink.prototype['id'] = undefined;
 ...
 */
ApplicationExternalLink.prototype['loginPageUrl'] = undefined;

/**
 * A string that specifies the name of the application. This is a required property.
 * @member {String} name
 */
ApplicationExternalLink.prototype['name'] = undefined;

/**
 * @member {module:model/EnumApplicationProtocol} protocol
 */
ApplicationExternalLink.prototype['protocol'] = undefined;

/**
 * @member {module:model/EnumApplicationType} type
 */
ApplicationExternalLink.prototype['type'] = undefined;

/**
 * The time the resource was last updated.
 * @member {Date} updatedAt
 */
ApplicationExternalLink.prototype['updatedAt'] = undefined;

/**
 * A string that specifies the custom home page URL for the application.
 * @member {String} homePageUrl
 */
ApplicationExternalLink.prototype['homePageUrl'] = undefined;
...
export default ApplicationExternalLink;