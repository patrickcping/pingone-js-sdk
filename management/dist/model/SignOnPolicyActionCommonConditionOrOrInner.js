...
class SignOnPolicyActionCommonConditionOrOrInner {
  ...
  constructor(instance = null) {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `SignOnPolicyActionCommonConditionOrOrInner` with oneOf schemas SignOnPolicyActionCommonConditionAggregate, SignOnPolicyActionCommonConditionAnd, SignOnPolicyActionCommonConditionNot, SignOnPolicyActionCommonConditionOr. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
