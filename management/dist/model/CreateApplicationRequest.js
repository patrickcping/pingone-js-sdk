...
class CreateApplicationRequest {
   ...
   * @param {(module:model/ApplicationExternalLink|module:model/ApplicationOIDC|module:model/ApplicationSAML|module:model/ApplicationWSFED)} instance The actual instance to initialize CreateApplicationRequest.
   */
  constructor(instance = null) {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `CreateApplicationRequest` with oneOf schemas ApplicationExternalLink, ApplicationOIDC, ApplicationSAML, ApplicationWSFED. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `CreateApplicationRequest` with oneOf schemas ApplicationExternalLink, ApplicationOIDC, ApplicationSAML, ApplicationWSFED. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  static constructFromObject(data, obj) {
    return new CreateApplicationRequest(data);
  }
  ...
  setActualInstance(obj) {
    this.actualInstance = CreateApplicationRequest.constructFromObject(obj).getActualInstance();
  }
   ...
   * @return {module:model/CreateApplicationRequest} An instance of CreateApplicationRequest.
   */
  static fromJSON = function (json_string) {
    return CreateApplicationRequest.constructFromObject(JSON.parse(json_string));
  };
}
 ...
 */
CreateApplicationRequest.prototype['_links'] = undefined;

/**
 * @member {module:model/ApplicationAccessControl} accessControl
 */
CreateApplicationRequest.prototype['accessControl'] = undefined;

/**
 * The time the resource was created.
 * @member {Date} createdAt
 */
CreateApplicationRequest.prototype['createdAt'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['enabled'] = undefined;

/**
 * @member {module:model/ObjectEnvironment} environment
 */
CreateApplicationRequest.prototype['environment'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['hiddenFromAppPortal'] = undefined;

/**
 * @member {module:model/ApplicationIcon} icon
 */
CreateApplicationRequest.prototype['icon'] = undefined;

/**
 * A string that specifies the application ID.
 * @member {String} id
 */
CreateApplicationRequest.prototype['id'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['loginPageUrl'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['protocol'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['updatedAt'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['acsUrls'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['assertionDuration'] = undefined;
 ...
 * @default true
 */
CreateApplicationRequest.prototype['assertionSigned'] = true;

/**
 * @member {module:model/ApplicationCorsSettings} corsSettings
 */
CreateApplicationRequest.prototype['corsSettings'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['defaultTargetUrl'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['enableRequestedAuthnContext'] = undefined;

/**
 * @member {module:model/ApplicationWSFEDAllOfIdpSigning} idpSigning
 */
CreateApplicationRequest.prototype['idpSigning'] = undefined;

/**
 * A string that specifies the format of the Subject NameID attibute in the SAML assertion
 * @member {String} nameIdFormat
 */
CreateApplicationRequest.prototype['nameIdFormat'] = undefined;
 ...
 * @default false
 */
CreateApplicationRequest.prototype['responseSigned'] = false;

/**
 * @member {module:model/EnumApplicationSAMLSloBinding} sloBinding
 */
CreateApplicationRequest.prototype['sloBinding'] = undefined;

/**
 * The single logout endpoint URL.
 * @member {String} sloEndpoint
 */
CreateApplicationRequest.prototype['sloEndpoint'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['sloResponseEndpoint'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['sloWindow'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['spEntityId'] = undefined;

/**
 * @member {module:model/ApplicationSAMLAllOfSpVerification} spVerification
 */
CreateApplicationRequest.prototype['spVerification'] = undefined;
 ...
 * @default true
 */
CreateApplicationRequest.prototype['additionalRefreshTokenReplayProtectionEnabled'] = true;
 ...
 */
CreateApplicationRequest.prototype['allowWildcardInRedirectUris'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['assignActorRoles'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['devicePathId'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['deviceCustomVerificationUri'] = undefined;
 ...
 * @default 600
 */
CreateApplicationRequest.prototype['deviceTimeout'] = 600;
 ...
 * @default 5
 */
CreateApplicationRequest.prototype['devicePollingInterval'] = 5;
 ...
 * @member {String} jwks
 */
CreateApplicationRequest.prototype['jwks'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['jwksUrl'] = undefined;

/**
 * @member {module:model/ApplicationOIDCAllOfMobile} mobile
 */
CreateApplicationRequest.prototype['mobile'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['bundleId'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['packageName'] = undefined;

/**
 * @member {module:model/ApplicationWSFEDAllOfKerberos} kerberos
 */
CreateApplicationRequest.prototype['kerberos'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['grantTypes'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['initiateLoginUri'] = undefined;

/**
 * @member {module:model/EnumApplicationOIDCPKCEOption} pkceEnforcement
 */
CreateApplicationRequest.prototype['pkceEnforcement'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['postLogoutRedirectUris'] = undefined;

/**
 * A string that specifies the callback URI for the authentication response.
 * @member {Array.<String>} redirectUris
 */
CreateApplicationRequest.prototype['redirectUris'] = undefined;
 ...
 * @default 2592000
 */
CreateApplicationRequest.prototype['refreshTokenDuration'] = 2592000;
 ...
 */
CreateApplicationRequest.prototype['refreshTokenRollingDuration'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['refreshTokenRollingGracePeriodDuration'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['responseTypes'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['requireSignedRequestObject'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['supportUnsignedRequestObject'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['targetLinkUri'] = undefined;

/**
 * @member {module:model/EnumApplicationOIDCTokenAuthMethod} tokenEndpointAuthMethod
 */
CreateApplicationRequest.prototype['tokenEndpointAuthMethod'] = undefined;

/**
 * @member {module:model/EnumApplicationOIDCPARRequirement} parRequirement
 */
CreateApplicationRequest.prototype['parRequirement'] = undefined;
 ...
 * @default 60
 */
CreateApplicationRequest.prototype['parTimeout'] = 60;

/**
 * @member {module:model/ApplicationOIDCAllOfSigning} signing
 */
CreateApplicationRequest.prototype['signing'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['audienceRestriction'] = 'urn:federation:MicrosoftOnline';

/**
 * The federated domain name (for example, the Azure custom domain).
 * @member {String} domainName
 */
CreateApplicationRequest.prototype['domainName'] = undefined;
 ...
 */
CreateApplicationRequest.prototype['replyUrl'] = undefined;
CreateApplicationRequest.OneOf = ["ApplicationExternalLink", "ApplicationOIDC", "ApplicationSAML", "ApplicationWSFED"];
