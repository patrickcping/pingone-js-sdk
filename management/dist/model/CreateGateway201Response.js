...
class CreateGateway201Response {
  ...
  constructor(instance = null) {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `CreateGateway201Response` with oneOf schemas Gateway, GatewayTypeLDAP, GatewayTypeRADIUS. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
