...
import ApplicationPingOneAdminConsole from './ApplicationPingOneAdminConsole';
...
/**
 * The ReadOneApplication200Response model module.
 * @module model/ReadOneApplication200Response
 * @version 2023-06-29
 */
class ReadOneApplication200Response {
  /**
   * Constructs a new <code>ReadOneApplication200Response</code>.
   * @alias module:model/ReadOneApplication200Response
   * @param {(module:model/ApplicationExternalLink|module:model/ApplicationOIDC|module:model/ApplicationPingOneAdminConsole|module:model/ApplicationPingOnePortal|module:model/ApplicationPingOneSelfService|module:model/ApplicationSAML|module:model/ApplicationWSFED)} instance The actual instance to initialize ReadOneApplication200Response.
   */
  constructor(instance = null) {
    ...
    try {
      if (typeof instance === "ApplicationPingOneAdminConsole") {
        this.actualInstance = instance;
      } else {
        // plain JS object
        // validate the object
        ApplicationPingOneAdminConsole.validateJSON(instance); // throw an exception if no match
        // create ApplicationPingOneAdminConsole from JS object
        this.actualInstance = ApplicationPingOneAdminConsole.constructFromObject(instance);
      }
      match++;
    } catch (err) {
      // json data failed to deserialize into ApplicationPingOneAdminConsole
      errorMessages.push("Failed to construct ApplicationPingOneAdminConsole: " + err);
    }
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ReadOneApplication200Response` with oneOf schemas ApplicationExternalLink, ApplicationOIDC, ApplicationPingOneAdminConsole, ApplicationPingOnePortal, ApplicationPingOneSelfService, ApplicationSAML, ApplicationWSFED. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ReadOneApplication200Response` with oneOf schemas ApplicationExternalLink, ApplicationOIDC, ApplicationPingOneAdminConsole, ApplicationPingOnePortal, ApplicationPingOneSelfService, ApplicationSAML, ApplicationWSFED. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ReadOneApplication200Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReadOneApplication200Response} obj Optional instance to populate.
   * @return {module:model/ReadOneApplication200Response} The populated <code>ReadOneApplication200Response</code> instance.
   */
  static constructFromObject(data, obj) {
    return new ReadOneApplication200Response(data);
  }

  /**
   * Gets the actual instance, which can be <code>ApplicationExternalLink</code>, <code>ApplicationOIDC</code>, <code>ApplicationPingOneAdminConsole</code>, <code>ApplicationPingOnePortal</code>, <code>ApplicationPingOneSelfService</code>, <code>ApplicationSAML</code>, <code>ApplicationWSFED</code>.
   * @return {(module:model/ApplicationExternalLink|module:model/ApplicationOIDC|module:model/ApplicationPingOneAdminConsole|module:model/ApplicationPingOnePortal|module:model/ApplicationPingOneSelfService|module:model/ApplicationSAML|module:model/ApplicationWSFED)} The actual instance.
   */
  getActualInstance() {
  ...
  /**
   * Sets the actual instance, which can be <code>ApplicationExternalLink</code>, <code>ApplicationOIDC</code>, <code>ApplicationPingOneAdminConsole</code>, <code>ApplicationPingOnePortal</code>, <code>ApplicationPingOneSelfService</code>, <code>ApplicationSAML</code>, <code>ApplicationWSFED</code>.
   * @param {(module:model/ApplicationExternalLink|module:model/ApplicationOIDC|module:model/ApplicationPingOneAdminConsole|module:model/ApplicationPingOnePortal|module:model/ApplicationPingOneSelfService|module:model/ApplicationSAML|module:model/ApplicationWSFED)} obj The actual instance.
   */
  setActualInstance(obj) {
    this.actualInstance = ReadOneApplication200Response.constructFromObject(obj).getActualInstance();
  }
  ...
  /**
   * Create an instance of ReadOneApplication200Response from a JSON string.
   * @param {string} json_string JSON string.
   * @return {module:model/ReadOneApplication200Response} An instance of ReadOneApplication200Response.
   */
  static fromJSON = function (json_string) {
    return ReadOneApplication200Response.constructFromObject(JSON.parse(json_string));
  };
}
 ...
 */
ReadOneApplication200Response.prototype['_links'] = undefined;

/**
 * @member {module:model/ApplicationAccessControl} accessControl
 */
ReadOneApplication200Response.prototype['accessControl'] = undefined;

/**
 * The time the resource was created.
 * @member {Date} createdAt
 */
ReadOneApplication200Response.prototype['createdAt'] = undefined;

/**
 * A string that specifies the description of the application.
 * @member {String} description
 */
ReadOneApplication200Response.prototype['description'] = undefined;

/**
 * A string that specifies the current enabled state of the application. Options are ENABLED or DISABLED.
 * @member {Boolean} enabled
 */
ReadOneApplication200Response.prototype['enabled'] = undefined;

/**
 * @member {module:model/ObjectEnvironment} environment
 */
ReadOneApplication200Response.prototype['environment'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['hiddenFromAppPortal'] = undefined;

/**
 * @member {module:model/ApplicationIcon} icon
 */
ReadOneApplication200Response.prototype['icon'] = undefined;

/**
 * A string that specifies the application ID.
 * @member {String} id
 */
ReadOneApplication200Response.prototype['id'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['loginPageUrl'] = undefined;

/**
 * A string that specifies the name of the application. This is a required property.
 * @member {String} name
 */
ReadOneApplication200Response.prototype['name'] = undefined;

/**
 * @member {module:model/EnumApplicationProtocol} protocol
 */
ReadOneApplication200Response.prototype['protocol'] = undefined;

/**
 * @member {module:model/EnumApplicationType} type
 */
ReadOneApplication200Response.prototype['type'] = undefined;

/**
 * The time the resource was last updated.
 * @member {Date} updatedAt
 */
ReadOneApplication200Response.prototype['updatedAt'] = undefined;

/**
 * A string that specifies the custom home page URL for the application.
 * @member {String} homePageUrl
 */
ReadOneApplication200Response.prototype['homePageUrl'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['acsUrls'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['assertionDuration'] = undefined;
 ...
 * @default true
 */
ReadOneApplication200Response.prototype['assertionSigned'] = true;

/**
 * @member {module:model/ApplicationCorsSettings} corsSettings
 */
ReadOneApplication200Response.prototype['corsSettings'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['defaultTargetUrl'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['enableRequestedAuthnContext'] = undefined;

/**
 * @member {module:model/ApplicationWSFEDAllOfIdpSigning} idpSigning
 */
ReadOneApplication200Response.prototype['idpSigning'] = undefined;

/**
 * A string that specifies the format of the Subject NameID attibute in the SAML assertion
 * @member {String} nameIdFormat
 */
ReadOneApplication200Response.prototype['nameIdFormat'] = undefined;
 ...
 * @default false
 */
ReadOneApplication200Response.prototype['responseSigned'] = false;

/**
 * @member {module:model/EnumApplicationSAMLSloBinding} sloBinding
 */
ReadOneApplication200Response.prototype['sloBinding'] = undefined;

/**
 * The single logout endpoint URL.
 * @member {String} sloEndpoint
 */
ReadOneApplication200Response.prototype['sloEndpoint'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['sloResponseEndpoint'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['sloWindow'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['spEntityId'] = undefined;

/**
 * @member {module:model/ApplicationSAMLAllOfSpVerification} spVerification
 */
ReadOneApplication200Response.prototype['spVerification'] = undefined;
 ...
 * @default true
 */
ReadOneApplication200Response.prototype['additionalRefreshTokenReplayProtectionEnabled'] = true;
 ...
 */
ReadOneApplication200Response.prototype['allowWildcardInRedirectUris'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['assignActorRoles'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['devicePathId'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['deviceCustomVerificationUri'] = undefined;
 ...
 * @default 600
 */
ReadOneApplication200Response.prototype['deviceTimeout'] = 600;
 ...
 * @default 5
 */
ReadOneApplication200Response.prototype['devicePollingInterval'] = 5;
 ...
 * @member {String} jwks
 */
ReadOneApplication200Response.prototype['jwks'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['jwksUrl'] = undefined;

/**
 * @member {module:model/ApplicationOIDCAllOfMobile} mobile
 */
ReadOneApplication200Response.prototype['mobile'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['bundleId'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['packageName'] = undefined;

/**
 * @member {module:model/ApplicationWSFEDAllOfKerberos} kerberos
 */
ReadOneApplication200Response.prototype['kerberos'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['grantTypes'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['initiateLoginUri'] = undefined;

/**
 * @member {module:model/EnumApplicationOIDCPKCEOption} pkceEnforcement
 */
ReadOneApplication200Response.prototype['pkceEnforcement'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['postLogoutRedirectUris'] = undefined;

/**
 * A string that specifies the callback URI for the authentication response.
 * @member {Array.<String>} redirectUris
 */
ReadOneApplication200Response.prototype['redirectUris'] = undefined;
 ...
 * @default 2592000
 */
ReadOneApplication200Response.prototype['refreshTokenDuration'] = 2592000;
 ...
 */
ReadOneApplication200Response.prototype['refreshTokenRollingDuration'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['refreshTokenRollingGracePeriodDuration'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['responseTypes'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['requireSignedRequestObject'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['supportUnsignedRequestObject'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['tags'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['targetLinkUri'] = undefined;

/**
 * @member {module:model/EnumApplicationOIDCTokenAuthMethod} tokenEndpointAuthMethod
 */
ReadOneApplication200Response.prototype['tokenEndpointAuthMethod'] = undefined;

/**
 * @member {module:model/EnumApplicationOIDCPARRequirement} parRequirement
 */
ReadOneApplication200Response.prototype['parRequirement'] = undefined;
 ...
 * @default 60
 */
ReadOneApplication200Response.prototype['parTimeout'] = 60;

/**
 * @member {module:model/ApplicationOIDCAllOfSigning} signing
 */
ReadOneApplication200Response.prototype['signing'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['audienceRestriction'] = 'urn:federation:MicrosoftOnline';

/**
 * The federated domain name (for example, the Azure custom domain).
 * @member {String} domainName
 */
ReadOneApplication200Response.prototype['domainName'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['replyUrl'] = undefined;

/**
 * If `true`, applies the default theme to the self service application.
 * @member {Boolean} applyDefaultTheme
 */
ReadOneApplication200Response.prototype['applyDefaultTheme'] = undefined;
 ...
 */
ReadOneApplication200Response.prototype['enableDefaultThemeFooter'] = undefined;
ReadOneApplication200Response.OneOf = ["ApplicationExternalLink", "ApplicationOIDC", "ApplicationPingOneAdminConsole", "ApplicationPingOnePortal", "ApplicationPingOneSelfService", "ApplicationSAML", "ApplicationWSFED"];
export default ReadOneApplication200Response;