...
/**
 * The IdentityProviderApple model module.
 * @module model/IdentityProviderApple
 * @version 2023-06-29
 */
class IdentityProviderApple {
  /**
   * Constructs a new <code>IdentityProviderApple</code>.
   * @alias module:model/IdentityProviderApple
   ...
   * @param clientId {String} A string that specifies the application ID from Apple. This is the identifier obtained after registering a services ID in the Apple developer portal. This is a required property.
   * @param clientSecretSigningKey {String} A string that specifies the private key that is used to generate a client secret. This is a required property.
   * @param keyId {String} A 10-character string that Apple uses to identify an authentication key. This is a required property.
   * @param teamId {String} A 10-character string that Apple uses to identify teams. This is a required property.
   */
  constructor(enabled, name, type, clientId, clientSecretSigningKey, keyId, teamId) {
    IdentityProviderCommon.initialize(this, enabled, name, type);
    IdentityProviderApple.initialize(this, enabled, name, type, clientId, clientSecretSigningKey, keyId, teamId);
  }
   ...
   */
  static initialize(obj, enabled, name, type, clientId, clientSecretSigningKey, keyId, teamId) {
    obj['enabled'] = enabled;
    obj['name'] = name;
    obj['type'] = type;
    obj['clientId'] = clientId;
    obj['clientSecretSigningKey'] = clientSecretSigningKey;
    obj['keyId'] = keyId;
    obj['teamId'] = teamId;
  }

  /**
   * Constructs a <code>IdentityProviderApple</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IdentityProviderApple} obj Optional instance to populate.
   * @return {module:model/IdentityProviderApple} The populated <code>IdentityProviderApple</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new IdentityProviderApple();
      ...
      if (data.hasOwnProperty('clientSecretSigningKey')) {
        obj['clientSecretSigningKey'] = ApiClient.convertToType(data['clientSecretSigningKey'], 'String');
      }
  ...
  /**
   * Validates the JSON data with respect to <code>IdentityProviderApple</code>.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentityProviderApple</code>.
   */
  static validateJSON(data) {
    // check to make sure all required properties are present in the JSON string
    for (const property of IdentityProviderApple.RequiredProperties) {
    ...
    // ensure the json data is a string
    if (data['clientSecretSigningKey'] && !(typeof data['clientSecretSigningKey'] === 'string' || data['clientSecretSigningKey'] instanceof String)) {
      throw new Error("Expected the field `clientSecretSigningKey` to be a primitive type in the JSON string but got " + data['clientSecretSigningKey']);
    }
    // ensure the json data is a string
...
IdentityProviderApple.RequiredProperties = ["enabled", "name", "type", "clientId", "clientSecretSigningKey", "keyId", "teamId"];

/**
 * @member {module:model/LinksHATEOAS} _links
 */
IdentityProviderApple.prototype['_links'] = undefined;

/**
 * The description of the IdP.
 * @member {String} description
 */
IdentityProviderApple.prototype['description'] = undefined;

/**
 * The current enabled state of the IdP.
 * @member {Boolean} enabled
 */
IdentityProviderApple.prototype['enabled'] = undefined;

/**
 * @member {module:model/ObjectEnvironment} environment
 */
IdentityProviderApple.prototype['environment'] = undefined;

/**
 * @member {module:model/IdentityProviderCommonIcon} icon
 */
IdentityProviderApple.prototype['icon'] = undefined;

/**
 * The resource ID.
 * @member {String} id
 */
IdentityProviderApple.prototype['id'] = undefined;

/**
 * @member {module:model/IdentityProviderCommonLoginButtonIcon} loginButtonIcon
 */
IdentityProviderApple.prototype['loginButtonIcon'] = undefined;

/**
 * The name of the IdP.
 * @member {String} name
 */
IdentityProviderApple.prototype['name'] = undefined;

/**
 * @member {module:model/IdentityProviderCommonRegistration} registration
 */
IdentityProviderApple.prototype['registration'] = undefined;

/**
 * @member {module:model/EnumIdentityProviderExt} type
 */
IdentityProviderApple.prototype['type'] = undefined;

/**
 * The time the resource was created.
 * @member {String} createdAt
 */
IdentityProviderApple.prototype['createdAt'] = undefined;

/**
 * The time the resource was last updated.
 * @member {String} updatedAt
 */
IdentityProviderApple.prototype['updatedAt'] = undefined;
 ...
 */
IdentityProviderApple.prototype['clientId'] = undefined;
...
export default IdentityProviderApple;