...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationsApi();
  });
  ...
  describe('ApplicationsApi', function() {
    ...
    describe('readAllApplications', function() {
      it('should call readAllApplications successfully', function(done) {
        //uncomment below and update the code to test readAllApplications
        //instance.readAllApplications(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('readOneApplication', function() {
      it('should call readOneApplication successfully', function(done) {
        //uncomment below and update the code to test readOneApplication
        //instance.readOneApplication(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
