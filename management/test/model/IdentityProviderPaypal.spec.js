...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.IdentityProviderPaypal();
  });
  ...
  describe('IdentityProviderPaypal', function() {
    it('should create an instance of IdentityProviderPaypal', function() {
      // uncomment below and update the code to test IdentityProviderPaypal
      //var instance = new PingOnePlatformApiSsoAndBase.IdentityProviderPaypal();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.IdentityProviderPaypal);
    });
