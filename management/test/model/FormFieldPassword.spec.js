...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.FormFieldPassword();
  });
  ...
  describe('FormFieldPassword', function() {
    it('should create an instance of FormFieldPassword', function() {
      // uncomment below and update the code to test FormFieldPassword
      //var instance = new PingOnePlatformApiSsoAndBase.FormFieldPassword();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.FormFieldPassword);
    });
