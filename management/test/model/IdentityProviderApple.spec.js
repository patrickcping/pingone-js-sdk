...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.IdentityProviderApple();
  });
  ...
  describe('IdentityProviderApple', function() {
    it('should create an instance of IdentityProviderApple', function() {
      // uncomment below and update the code to test IdentityProviderApple
      //var instance = new PingOnePlatformApiSsoAndBase.IdentityProviderApple();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.IdentityProviderApple);
    });
