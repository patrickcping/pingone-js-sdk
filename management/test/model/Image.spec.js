...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.Image();
  });
  ...
  describe('Image', function() {
    it('should create an instance of Image', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.Image();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.Image);
    });
