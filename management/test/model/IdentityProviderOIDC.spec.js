...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.IdentityProviderOIDC();
  });
  ...
  describe('IdentityProviderOIDC', function() {
    it('should create an instance of IdentityProviderOIDC', function() {
      // uncomment below and update the code to test IdentityProviderOIDC
      //var instance = new PingOnePlatformApiSsoAndBase.IdentityProviderOIDC();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.IdentityProviderOIDC);
    });
