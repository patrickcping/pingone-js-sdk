...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationOIDCInternal();
  });
  ...
  describe('ApplicationOIDCInternal', function() {
    it('should create an instance of ApplicationOIDCInternal', function() {
      // uncomment below and update the code to test ApplicationOIDCInternal
      //var instance = new PingOnePlatformApiSsoAndBase.ApplicationOIDCInternal();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ApplicationOIDCInternal);
    });
