...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.BrandingSettings();
  });
  ...
  describe('BrandingSettings', function() {
    it('should create an instance of BrandingSettings', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.BrandingSettings();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.BrandingSettings);
    });
