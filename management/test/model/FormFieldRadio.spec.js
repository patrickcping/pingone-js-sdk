...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.FormFieldRadio();
  });
  ...
  describe('FormFieldRadio', function() {
    it('should create an instance of FormFieldRadio', function() {
      // uncomment below and update the code to test FormFieldRadio
      //var instance = new PingOnePlatformApiSsoAndBase.FormFieldRadio();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.FormFieldRadio);
    });
