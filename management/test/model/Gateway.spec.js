...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.Gateway();
  });
  ...
  describe('Gateway', function() {
    it('should create an instance of Gateway', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.Gateway();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.Gateway);
    });
