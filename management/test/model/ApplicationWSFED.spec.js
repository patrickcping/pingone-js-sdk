...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationWSFED();
  });
  ...
  describe('ApplicationWSFED', function() {
    it('should create an instance of ApplicationWSFED', function() {
      // uncomment below and update the code to test ApplicationWSFED
      //var instance = new PingOnePlatformApiSsoAndBase.ApplicationWSFED();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ApplicationWSFED);
    });
