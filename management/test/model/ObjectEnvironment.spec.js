...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ObjectEnvironment();
  });
  ...
  describe('ObjectEnvironment', function() {
    it('should create an instance of ObjectEnvironment', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.ObjectEnvironment();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ObjectEnvironment);
    });
