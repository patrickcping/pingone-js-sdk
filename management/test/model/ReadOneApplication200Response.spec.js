...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ReadOneApplication200Response();
  });
  ...
  describe('ReadOneApplication200Response', function() {
    it('should create an instance of ReadOneApplication200Response', function() {
      // uncomment below and update the code to test ReadOneApplication200Response
      //var instance = new PingOnePlatformApiSsoAndBase.ReadOneApplication200Response();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ReadOneApplication200Response);
    });
