...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationOIDC();
  });
  ...
  describe('ApplicationOIDC', function() {
    it('should create an instance of ApplicationOIDC', function() {
      // uncomment below and update the code to test ApplicationOIDC
      //var instance = new PingOnePlatformApiSsoAndBase.ApplicationOIDC();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ApplicationOIDC);
    });
