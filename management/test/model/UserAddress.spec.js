...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.UserAddress();
  });
  ...
  describe('UserAddress', function() {
    it('should create an instance of UserAddress', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.UserAddress();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.UserAddress);
    });
