...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.EmailDomain();
  });
  ...
  describe('EmailDomain', function() {
    it('should create an instance of EmailDomain', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.EmailDomain();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.EmailDomain);
    });
