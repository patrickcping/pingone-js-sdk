...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationSecret();
  });
  ...
  describe('ApplicationSecret', function() {
    it('should create an instance of ApplicationSecret', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.ApplicationSecret();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ApplicationSecret);
    });
