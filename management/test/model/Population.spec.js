...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.Population();
  });
  ...
  describe('Population', function() {
    it('should create an instance of Population', function() {
      // uncomment below and update the code to test Population
      //var instance = new PingOnePlatformApiSsoAndBase.Population();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.Population);
    });
