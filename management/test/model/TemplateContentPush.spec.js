...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.TemplateContentPush();
  });
  ...
  describe('TemplateContentPush', function() {
    it('should create an instance of TemplateContentPush', function() {
      // uncomment below and update the code to test TemplateContentPush
      //var instance = new PingOnePlatformApiSsoAndBase.TemplateContentPush();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.TemplateContentPush);
    });
