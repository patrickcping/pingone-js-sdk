...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.PropagationStore();
  });
  ...
  describe('PropagationStore', function() {
    it('should create an instance of PropagationStore', function() {
      // uncomment below and update the code to test PropagationStore
      //var instance = new PingOnePlatformApiSsoAndBase.PropagationStore();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.PropagationStore);
    });
