...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationResourceGrant();
  });
  ...
  describe('ApplicationResourceGrant', function() {
    it('should create an instance of ApplicationResourceGrant', function() {
      // uncomment below and update the code to test ApplicationResourceGrant
      //var instance = new PingOnePlatformApiSsoAndBase.ApplicationResourceGrant();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ApplicationResourceGrant);
    });
