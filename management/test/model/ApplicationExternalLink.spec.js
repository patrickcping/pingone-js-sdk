...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationExternalLink();
  });
  ...
  describe('ApplicationExternalLink', function() {
    it('should create an instance of ApplicationExternalLink', function() {
      // uncomment below and update the code to test ApplicationExternalLink
      //var instance = new PingOnePlatformApiSsoAndBase.ApplicationExternalLink();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ApplicationExternalLink);
    });
