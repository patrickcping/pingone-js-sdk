...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.TemplateContentEmail();
  });
  ...
  describe('TemplateContentEmail', function() {
    it('should create an instance of TemplateContentEmail', function() {
      // uncomment below and update the code to test TemplateContentEmail
      //var instance = new PingOnePlatformApiSsoAndBase.TemplateContentEmail();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.TemplateContentEmail);
    });
