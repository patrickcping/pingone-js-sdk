...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.GroupMembership();
  });
  ...
  describe('GroupMembership', function() {
    it('should create an instance of GroupMembership', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.GroupMembership();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.GroupMembership);
    });
