...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.FormFieldText();
  });
  ...
  describe('FormFieldText', function() {
    it('should create an instance of FormFieldText', function() {
      // uncomment below and update the code to test FormFieldText
      //var instance = new PingOnePlatformApiSsoAndBase.FormFieldText();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.FormFieldText);
    });
