...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.ApplicationPingOnePortal();
  });
  ...
  describe('ApplicationPingOnePortal', function() {
    it('should create an instance of ApplicationPingOnePortal', function() {
      // uncomment below and update the code to test ApplicationPingOnePortal
      //var instance = new PingOnePlatformApiSsoAndBase.ApplicationPingOnePortal();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.ApplicationPingOnePortal);
    });
