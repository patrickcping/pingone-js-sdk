...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.UpdateApplicationRequest();
  });
  ...
  describe('UpdateApplicationRequest', function() {
    it('should create an instance of UpdateApplicationRequest', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.UpdateApplicationRequest();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.UpdateApplicationRequest);
    });
