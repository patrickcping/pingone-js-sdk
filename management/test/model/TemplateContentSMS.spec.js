...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.TemplateContentSMS();
  });
  ...
  describe('TemplateContentSMS', function() {
    it('should create an instance of TemplateContentSMS', function() {
      // uncomment below and update the code to test TemplateContentSMS
      //var instance = new PingOnePlatformApiSsoAndBase.TemplateContentSMS();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.TemplateContentSMS);
    });
