...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.IdentityProviderCommon();
  });
  ...
  describe('IdentityProviderCommon', function() {
    it('should create an instance of IdentityProviderCommon', function() {
      // uncomment below and update the code to test IdentityProviderCommon
      //var instance = new PingOnePlatformApiSsoAndBase.IdentityProviderCommon();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.IdentityProviderCommon);
    });
