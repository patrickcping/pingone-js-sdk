...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.TemplateContentCommon();
  });
  ...
  describe('TemplateContentCommon', function() {
    it('should create an instance of TemplateContentCommon', function() {
      // uncomment below and update the code to test TemplateContentCommon
      //var instance = new PingOnePlatformApiSsoAndBase.TemplateContentCommon();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.TemplateContentCommon);
    });
