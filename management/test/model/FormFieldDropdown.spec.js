...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.FormFieldDropdown();
  });
  ...
  describe('FormFieldDropdown', function() {
    it('should create an instance of FormFieldDropdown', function() {
      // uncomment below and update the code to test FormFieldDropdown
      //var instance = new PingOnePlatformApiSsoAndBase.FormFieldDropdown();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.FormFieldDropdown);
    });
