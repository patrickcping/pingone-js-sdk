...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.CreateApplication201Response();
  });
  ...
  describe('CreateApplication201Response', function() {
    it('should create an instance of CreateApplication201Response', function() {
      // uncomment below and update the code to test CreateApplication201Response
      //var instance = new PingOnePlatformApiSsoAndBase.CreateApplication201Response();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.CreateApplication201Response);
    });
