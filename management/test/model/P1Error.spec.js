...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.P1Error();
  });
  ...
  describe('P1Error', function() {
    it('should create an instance of P1Error', function() {
      ...
      //var instance = new PingOnePlatformApiSsoAndBase.P1Error();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.P1Error);
    });
