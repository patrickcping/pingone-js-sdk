...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.FormFieldCombobox();
  });
  ...
  describe('FormFieldCombobox', function() {
    it('should create an instance of FormFieldCombobox', function() {
      // uncomment below and update the code to test FormFieldCombobox
      //var instance = new PingOnePlatformApiSsoAndBase.FormFieldCombobox();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.FormFieldCombobox);
    });
