...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.FormFieldPasswordVerify();
  });
  ...
  describe('FormFieldPasswordVerify', function() {
    it('should create an instance of FormFieldPasswordVerify', function() {
      // uncomment below and update the code to test FormFieldPasswordVerify
      //var instance = new PingOnePlatformApiSsoAndBase.FormFieldPasswordVerify();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.FormFieldPasswordVerify);
    });
