...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.IdentityProviderClientIDClientSecret();
  });
  ...
  describe('IdentityProviderClientIDClientSecret', function() {
    it('should create an instance of IdentityProviderClientIDClientSecret', function() {
      // uncomment below and update the code to test IdentityProviderClientIDClientSecret
      //var instance = new PingOnePlatformApiSsoAndBase.IdentityProviderClientIDClientSecret();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.IdentityProviderClientIDClientSecret);
    });
