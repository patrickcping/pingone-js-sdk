...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiSsoAndBase.SignOnPolicyAssignment();
  });
  ...
  describe('SignOnPolicyAssignment', function() {
    it('should create an instance of SignOnPolicyAssignment', function() {
      // uncomment below and update the code to test SignOnPolicyAssignment
      //var instance = new PingOnePlatformApiSsoAndBase.SignOnPolicyAssignment();
      //expect(instance).to.be.a(PingOnePlatformApiSsoAndBase.SignOnPolicyAssignment);
    });
