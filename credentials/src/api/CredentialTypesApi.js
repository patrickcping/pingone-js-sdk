    ...
    */
    ...
    createCredentialTypeWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/credentialTypes', 'POST',
    ...
    createCredentialType(environmentID, opts) {
      return this.createCredentialTypeWithHttpInfo(environmentID, opts)
    ...
    deleteCredentialTypeWithHttpInfo(environmentID, credentialTypeID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/credentialTypes/{credentialTypeID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteCredentialType(environmentID, credentialTypeID) {
      return this.deleteCredentialTypeWithHttpInfo(environmentID, credentialTypeID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllCredentialTypesWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/credentialTypes', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllCredentialTypes(environmentID) {
      return this.readAllCredentialTypesWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneCredentialTypeWithHttpInfo(environmentID, credentialTypeID) {
      ...
      let returnType = CredentialType;
      return this.apiClient.callApi(
        '/environments/{environmentID}/credentialTypes/{credentialTypeID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneCredentialType(environmentID, credentialTypeID) {
      return this.readOneCredentialTypeWithHttpInfo(environmentID, credentialTypeID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateCredentialTypeWithHttpInfo(environmentID, credentialTypeID, opts) {
      ...
      let returnType = CredentialType;
      return this.apiClient.callApi(
        '/environments/{environmentID}/credentialTypes/{credentialTypeID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateCredentialType(environmentID, credentialTypeID, opts) {
      return this.updateCredentialTypeWithHttpInfo(environmentID, credentialTypeID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
