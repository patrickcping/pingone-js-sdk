    ...
    */
    ...
    createDigitalWalletWithHttpInfo(environmentID, userID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/digitalWallets', 'POST',
    ...
    createDigitalWallet(environmentID, userID, opts) {
      return this.createDigitalWalletWithHttpInfo(environmentID, userID, opts)
    ...
    deleteDigitalWalletWithHttpInfo(environmentID, userID, digitalWalletID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/digitalWallets/{digitalWalletID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteDigitalWallet(environmentID, userID, digitalWalletID) {
      return this.deleteDigitalWalletWithHttpInfo(environmentID, userID, digitalWalletID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllDigitalWalletsWithHttpInfo(environmentID, userID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/digitalWallets', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllDigitalWallets(environmentID, userID) {
      return this.readAllDigitalWalletsWithHttpInfo(environmentID, userID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneDigitalWalletWithHttpInfo(environmentID, userID, digitalWalletID) {
      ...
      let returnType = CredentialDigitalWallet;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/digitalWallets/{digitalWalletID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneDigitalWallet(environmentID, userID, digitalWalletID) {
      return this.readOneDigitalWalletWithHttpInfo(environmentID, userID, digitalWalletID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneDigitalWalletCredentialWithHttpInfo(environmentID, userID, digitalWalletID) {
      ...
      let returnType = EntityArray;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/digitalWallets/{digitalWalletID}/provisionedCredentials', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneDigitalWalletCredential(environmentID, userID, digitalWalletID) {
      return this.readOneDigitalWalletCredentialWithHttpInfo(environmentID, userID, digitalWalletID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateDigitalWalletWithHttpInfo(environmentID, userID, digitalWalletID, opts) {
      ...
      let returnType = CredentialDigitalWallet;
      return this.apiClient.callApi(
        '/environments/{environmentID}/users/{userID}/digitalWallets/{digitalWalletID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateDigitalWallet(environmentID, userID, digitalWalletID, opts) {
      return this.updateDigitalWalletWithHttpInfo(environmentID, userID, digitalWalletID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
