...
class ApiClient {
   ...
   */
  constructor(basePath = 'https://api.pingone.com/v1') {
    /**
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
     ...
     */
    this.defaultHeaders = {
      'User-Agent': 'pingtools PingOne-JS-SDK-credentials/0.0.1'
    };
