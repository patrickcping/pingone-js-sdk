...
export default class DigitalWalletAppsApi {
  ...
  */
  ...
  createDigitalWalletAppWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/digitalWalletApplications', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createDigitalWalletApp(environmentID, opts) {
    return this.createDigitalWalletAppWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteDigitalWalletAppWithHttpInfo(environmentID, digitalWalletApplicationID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/digitalWalletApplications/{digitalWalletApplicationID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteDigitalWalletApp(environmentID, digitalWalletApplicationID) {
    return this.deleteDigitalWalletAppWithHttpInfo(environmentID, digitalWalletApplicationID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllDigitalWalletAppsWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/digitalWalletApplications', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllDigitalWalletApps(environmentID) {
    return this.readAllDigitalWalletAppsWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneDigitalWalletAppWithHttpInfo(environmentID, digitalWalletApplicationID) {
    ...
    let accepts = ['application/json'];
    let returnType = DigitalWalletApplication;
    return this.apiClient.callApi('/environments/{environmentID}/digitalWalletApplications/{digitalWalletApplicationID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneDigitalWalletApp(environmentID, digitalWalletApplicationID) {
    return this.readOneDigitalWalletAppWithHttpInfo(environmentID, digitalWalletApplicationID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateDigitalWalletAppWithHttpInfo(environmentID, digitalWalletApplicationID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = DigitalWalletApplication;
    return this.apiClient.callApi('/environments/{environmentID}/digitalWalletApplications/{digitalWalletApplicationID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateDigitalWalletApp(environmentID, digitalWalletApplicationID, opts) {
    return this.updateDigitalWalletAppWithHttpInfo(environmentID, digitalWalletApplicationID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}