...
export default class UserCredentialsApi {
  ...
  */
  ...
  createAUserCredentialWithHttpInfo(environmentID, userID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/credentials', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createAUserCredential(environmentID, userID, opts) {
    return this.createAUserCredentialWithHttpInfo(environmentID, userID, opts).then(function (response_and_data) {
  ...
  readAllUserCredentialsWithHttpInfo(environmentID, userID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/credentials', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllUserCredentials(environmentID, userID) {
    return this.readAllUserCredentialsWithHttpInfo(environmentID, userID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneUserCredentialWithHttpInfo(environmentID, userID, credentialID) {
    ...
    let accepts = ['application/json'];
    let returnType = UserCredential;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/credentials/{credentialID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneUserCredential(environmentID, userID, credentialID) {
    return this.readOneUserCredentialWithHttpInfo(environmentID, userID, credentialID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneUserCredentialWalletWithHttpInfo(environmentID, userID, credentialID) {
    ...
    let accepts = ['application/json'];
    let returnType = EntityArray;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/credentials/{credentialID}/provisionedCredentials', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneUserCredentialWallet(environmentID, userID, credentialID) {
    return this.readOneUserCredentialWalletWithHttpInfo(environmentID, userID, credentialID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateUserCredentialWithHttpInfo(environmentID, userID, credentialID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = UserCredential;
    return this.apiClient.callApi('/environments/{environmentID}/users/{userID}/credentials/{credentialID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateUserCredential(environmentID, userID, credentialID, opts) {
    return this.updateUserCredentialWithHttpInfo(environmentID, userID, credentialID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}