...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiCredentials.P1ErrorDetailsInner();
  });
  ...
  describe('P1ErrorDetailsInner', function() {
    it('should create an instance of P1ErrorDetailsInner', function() {
      ...
      //var instance = new PingOnePlatformApiCredentials.P1ErrorDetailsInner();
      //expect(instance).to.be.a(PingOnePlatformApiCredentials.P1ErrorDetailsInner);
    });
