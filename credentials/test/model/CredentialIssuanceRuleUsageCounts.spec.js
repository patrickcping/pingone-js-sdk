...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiCredentials.CredentialIssuanceRuleUsageCounts();
  });
  ...
  describe('CredentialIssuanceRuleUsageCounts', function() {
    it('should create an instance of CredentialIssuanceRuleUsageCounts', function() {
      // uncomment below and update the code to test CredentialIssuanceRuleUsageCounts
      //var instance = new PingOnePlatformApiCredentials.CredentialIssuanceRuleUsageCounts();
      //expect(instance).to.be.a(PingOnePlatformApiCredentials.CredentialIssuanceRuleUsageCounts);
    });
