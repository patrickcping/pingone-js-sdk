...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiCredentials.ObjectEnvironment();
  });
  ...
  describe('ObjectEnvironment', function() {
    it('should create an instance of ObjectEnvironment', function() {
      ...
      //var instance = new PingOnePlatformApiCredentials.ObjectEnvironment();
      //expect(instance).to.be.a(PingOnePlatformApiCredentials.ObjectEnvironment);
    });
