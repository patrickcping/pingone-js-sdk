...
export default class VerifyPoliciesApi {
  ...
  */
  ...
  createVerifyPolicyWithHttpInfo(environmentID, opts) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/verifyPolicies', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  createVerifyPolicy(environmentID, opts) {
    return this.createVerifyPolicyWithHttpInfo(environmentID, opts).then(function (response_and_data) {
  ...
  deleteVerifyPolicyWithHttpInfo(environmentID, verifyPolicyID) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/environments/{environmentID}/verifyPolicies/{verifyPolicyID}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  deleteVerifyPolicy(environmentID, verifyPolicyID) {
    return this.deleteVerifyPolicyWithHttpInfo(environmentID, verifyPolicyID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readAllVerifyPoliciesWithHttpInfo(environmentID) {
    ...
    return this.apiClient.callApi('/environments/{environmentID}/verifyPolicies', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readAllVerifyPolicies(environmentID) {
    return this.readAllVerifyPoliciesWithHttpInfo(environmentID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  readOneVerifyPolicyWithHttpInfo(environmentID, verifyPolicyID) {
    ...
    let accepts = ['application/json'];
    let returnType = VerifyPolicy;
    return this.apiClient.callApi('/environments/{environmentID}/verifyPolicies/{verifyPolicyID}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  readOneVerifyPolicy(environmentID, verifyPolicyID) {
    return this.readOneVerifyPolicyWithHttpInfo(environmentID, verifyPolicyID).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  updateVerifyPolicyWithHttpInfo(environmentID, verifyPolicyID, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = VerifyPolicy;
    return this.apiClient.callApi('/environments/{environmentID}/verifyPolicies/{verifyPolicyID}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  ...
  updateVerifyPolicy(environmentID, verifyPolicyID, opts) {
    return this.updateVerifyPolicyWithHttpInfo(environmentID, verifyPolicyID, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
}