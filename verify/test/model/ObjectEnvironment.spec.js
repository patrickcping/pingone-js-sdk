...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneVerify.ObjectEnvironment();
  });
  ...
  describe('ObjectEnvironment', function() {
    it('should create an instance of ObjectEnvironment', function() {
      ...
      //var instance = new PingOnePlatformApiPingOneVerify.ObjectEnvironment();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneVerify.ObjectEnvironment);
    });
