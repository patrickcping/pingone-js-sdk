...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PingOnePlatformApiPingOneVerify.P1ErrorDetailsInner();
  });
  ...
  describe('P1ErrorDetailsInner', function() {
    it('should create an instance of P1ErrorDetailsInner', function() {
      ...
      //var instance = new PingOnePlatformApiPingOneVerify.P1ErrorDetailsInner();
      //expect(instance).to.be.a(PingOnePlatformApiPingOneVerify.P1ErrorDetailsInner);
    });
