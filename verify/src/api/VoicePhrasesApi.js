    ...
    */
    ...
    createVoicePhraseWithHttpInfo(environmentID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases', 'POST',
    ...
    createVoicePhrase(environmentID, opts) {
      return this.createVoicePhraseWithHttpInfo(environmentID, opts)
    ...
    deleteVoicePhraseWithHttpInfo(environmentID, voicePhraseID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteVoicePhrase(environmentID, voicePhraseID) {
      return this.deleteVoicePhraseWithHttpInfo(environmentID, voicePhraseID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllVoicePhrasesWithHttpInfo(environmentID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllVoicePhrases(environmentID) {
      return this.readAllVoicePhrasesWithHttpInfo(environmentID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneVoicePhraseWithHttpInfo(environmentID, voicePhraseID) {
      ...
      let returnType = VoicePhrase;
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneVoicePhrase(environmentID, voicePhraseID) {
      return this.readOneVoicePhraseWithHttpInfo(environmentID, voicePhraseID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateVoicePhraseWithHttpInfo(environmentID, voicePhraseID, opts) {
      ...
      let returnType = VoicePhrase;
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateVoicePhrase(environmentID, voicePhraseID, opts) {
      return this.updateVoicePhraseWithHttpInfo(environmentID, voicePhraseID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
