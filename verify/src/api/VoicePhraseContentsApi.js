    ...
    */
    ...
    createVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, opts) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}/contents', 'POST',
    ...
    createVoicePhraseContent(environmentID, voicePhraseID, opts) {
      return this.createVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, opts)
    ...
    deleteVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, voiceContentsID) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}/contents/{voiceContentsID}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteVoicePhraseContent(environmentID, voicePhraseID, voiceContentsID) {
      return this.deleteVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, voiceContentsID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readAllVoicePhraseContentsWithHttpInfo(environmentID, voicePhraseID) {
      ...
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}/contents', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readAllVoicePhraseContents(environmentID, voicePhraseID) {
      return this.readAllVoicePhraseContentsWithHttpInfo(environmentID, voicePhraseID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    readOneVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, voiceContentsID) {
      ...
      let returnType = VoicePhraseContents;
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}/contents/{voiceContentsID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    readOneVoicePhraseContent(environmentID, voicePhraseID, voiceContentsID) {
      return this.readOneVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, voiceContentsID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updateVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, voiceContentsID, opts) {
      ...
      let returnType = VoicePhraseContents;
      return this.apiClient.callApi(
        '/environments/{environmentID}/voicePhrases/{voicePhraseID}/contents/{voiceContentsID}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    updateVoicePhraseContent(environmentID, voicePhraseID, voiceContentsID, opts) {
      return this.updateVoicePhraseContentWithHttpInfo(environmentID, voicePhraseID, voiceContentsID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
